...
\makeatother
\newcommand{\versions}[1]{\textbf{\color{blue}{#1}}\vspace{-5pt}}
...
\indent
本模板 (2022/12/04 v1.4) 旨在为将合肥工业大学试卷的 word 格式转为\LaTeX{}格式.
使用时, 只需在文档开头写上
\begin{lstlisting}
...
\versions{2022/10/30 v1.1}
\begin{itemize}
\item 首次提交.
\end{itemize}

\versions{2022/10/31 v1.2}
\begin{itemize}
\item 选择题选项后增加了{\color{blue}5pt}的垂直间距.
\end{itemize}
\versions{2022/11/27 v1.3}
\begin{itemize}
\item 移除了简易模式下学期的下划线.
\item 打分框的宽度减少了{\color{blue}10\%}.
\end{itemize}
\versions{2022/12/04 v1.4}
\begin{itemize}
\item 修复了有时选择题选项未能正确计算行数的问题.
\item 修复了有时填空题答案会被横线截断的问题.
\end{itemize}
