\documentclass[cn,11pt,chinese,twoside,openright,usesamecnt]{elegantbook}
...
\let\question\relax
\elegantnewtheorem{question}{问题}{prostyle}{que}
...
\newcommand{\noun}[1]{\textcolor{blue}{{\kaishu #1}}\index{{#1}}}
\newcommand{\nouns}[2]{\textcolor{blue}{{\kaishu #1}}\index{{#2}}}
