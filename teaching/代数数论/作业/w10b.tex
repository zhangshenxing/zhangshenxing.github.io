...
\noindent{\bf 习题~3.2.28.}
对于 $\BC/\BR$, $n=2$, 证明 $\hil{a}{b}{\infty}=(-1)^{\frac{\sgn a-1}{2}\cdot\frac{b-1}{2}}.$
\begin{proof}
%在此证明
\end{proof}

\noindent{\bf 习题~3.2.31.}
$\leg{u}{\fp}=1$ 当且仅当 $u\mod \fp$ 是一个 $n$ 次方.
\begin{proof}
%在此证明
\end{proof}

\noindent{\bf 习题~3.2.32.}
...
(3) $\BA_\BQ/\BZ$ 任意唯一可除, 即对于任意 $y\in\BA_\BQ/\BZ,n\in\BZ$, 存在唯一的 $x\in\BA_\BQ/\BZ$ 使得 $nx=y$.
\begin{proof}
%在此证明
\end{proof}
