...
\noindent{\bf 习题~3.1.18.}
证明 $A\mapsto A_G$ 是右正合的.
\begin{proof}
%在此证明
\end{proof}

\noindent{\bf 习题~3.1.20.}
验证 $f_3,f_6$ 是良定义的, 并由此证明正合六边形.
\begin{proof}
%在此证明
\end{proof}

\noindent{\bf 习题~3.1.22.}
证明有限模的 Herbrand 商是 $1$.
\begin{proof}
%在此证明
\end{proof}

\noindent{\bf 习题~3.1.25.}
证明 $G$ 是有限循环群 时, $\RH^{-1}(G,\Ind^H_GB)\cong \RH^{-1}(H,B)$.
\begin{proof}
%在此证明
\end{proof}

\noindent{\bf 习题~3.1.26.}
如果 $G$ 是有限群, $H$ 是正规子群, 则 $\RH^1(G,\Ind^H_GB)\cong \RH^1(H,B)$.
\begin{proof}
%在此证明
\end{proof}
