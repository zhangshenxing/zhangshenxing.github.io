...
\noindent{\bf 习题~2.4.15.}
验证 $I_w\to \chi(L/K)$ 良定义且是群同态.
\begin{proof}
%在此证明
\end{proof}

\noindent{\bf 习题~2.4.19.}
$q\equiv -1 \mod 4$ 或 $q=2$ 时, $q$ 在 $K=\BQ(i,\sqrt{p})$ 的素位的分解群、惯性群、分歧群分别是什么?
\begin{proof}
%在此证明
\end{proof}

\noindent{\bf 习题~2.4.22.}
设 $\Pi$ 是 $\CO$ 的一个素元. 对于任意整数 $s\ge 0$,
