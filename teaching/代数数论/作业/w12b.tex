...
\noindent{\bf 习题~4.1.8.}
对于 
\[f_{t,\varepsilon}=x^\varepsilon e^{-\pi tx^2},\quad \varepsilon=0,1,\Re(t)>0,\]
证明
...
\noindent{\bf 习题~4.1.13.}
如果 $\chi$ 是实特征, 即 $\chi:(\BZ/m\BZ)^\times\to\pm 1$, 则 $\tau(\chi)= i^\varepsilon \sqrt{N}$.
\begin{proof}
%在此证明
\end{proof}

\noindent{\bf 习题~4.1.15.}
