...
\noindent{\bf 习题~2.2.24.}
令 $f(x,y)=x^2+y^2-1$, $P_0=(-1,0)$, 计算 $V(f)$.
\begin{proof}[解]
%在此解答
\end{proof}

\noindent{\bf 习题~2.2.25.}
当 $k=\infty$ 时如何处理? 是否有统一的做法?
\begin{proof}[解]
%在此解答
\end{proof}

\noindent{\bf 习题~2.2.26.}
令 $g(x,y,z)=x^2+y^2-5z^2$, 计算 $V(g)$.
\begin{proof}[解]
%在此解答
\end{proof}

\noindent{\bf 习题~2.2.30.}
