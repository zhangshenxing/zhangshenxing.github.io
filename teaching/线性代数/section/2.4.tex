...
\begin{frame}{例: 分块对角阵}
	...
	\begin{solution}
		...
		则 $\bfA_1^{-1}=\begin{pmatrix}
			1&-1\\-1&2
		\end{pmatrix},\quad\bfA_2^{-1}=\frac16\begin{pmatrix}
			3&0\\1&2
		\end{pmatrix}$.
		}
		
		\onslide<+->{故 $\bfA^{-1}=\diag(\bfA_1^{-1},\bfA_2^{-1})=\begin{pmatrix}
			1&-1&&\\
			-1&2&&\\
			&&\frac12&0\\[2mm]
			&&\frac16&\frac13
...
\begin{frame}{例: 分块三角阵的逆}
	...
	\onslide<+->
	\begin{solution}
		由 $\detm{\bfA&\bfO\\\bfC&\bfB}=|\bfA|\cdot|\bfB|\neq0$ 可知该方阵可逆.
		\onslide<+->{%
			设
			\[\begin{pmatrix}
				\bfA&\bfO\\\bfC&\bfB
...
\begin{frame}{例: 分块三角阵的逆}
	...
	\begin{solutionc}
		则
		\[\bfA\bfA_1=\bfE,\quad \bfA\bfA_2=\bfO,\quad \bfC\bfA_1+\bfB\bfA_3=\bfO,\quad \bfC\bfA_2+\bfB\bfA_4=\bfE.\]
		\onslide<+->{%
		于是
		\[\bfA_1=\bfA^{-1},\bfA_2=\bfO,\bfA_4=\bfB^{-1}.\]
		}\onslide<+->{%
