...
\begin{itemize}
	...
	\item 教材: 唐烁\ 朱士信《线性代数》
\end{itemize}
\begin{tikzpicture}[overlay,xshift=100mm,yshift=21mm]
...
\begin{frame}{线性代数的意义}
	\onslide<+->
	线性代数是一门利用代数方法研究\emph{线性方程、线性空间、线性变换}等线性结构的课程.
	\onslide<+->
...
\begin{frame}{课程学习方法}
	\begin{center}
		\begin{tikzpicture}[node distance=25pt]
			...
			\node[cstnodeg,align=center] (2) [below right=of 1] {\emph{课上}\\认真听课\\记好笔记};
			\node[cstnodeg,align=center] (3) [below left=of 2] {\emph{课后}\\过一遍教材\\与课上知识点};
			\node[cstnodeg,align=center] (4) [above left=of 3] {\emph{作业}\\检测学\\习效果};
