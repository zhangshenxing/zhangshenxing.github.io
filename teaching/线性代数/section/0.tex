	...
	\begin{tikzpicture}
		\begin{scope}
			...
			\node at (-5,1.7) [text width=53mm]  (1){
				\begin{main*}{作业 15分}[fontupper=\itshape]
					作业为配套练习册, 每两周交一次.
					\alertn{作业不允许迟交}.
		...
		\begin{scope}
			...
			\node at (4.7,1.8) [text width=43mm] (2){{\begin{second*}{课堂测验 25分}[fontupper=\itshape]
					课堂测验共3次, 取最高的两次平均. 测验范围和时间会提前通知. \alertn{测验时在教室内作答, 否则按未考处理}.
			\end{second*}}};
		\end{scope}
		...
		\begin{scope}
			...
			\node at (4.7,-1.5) [text width=43mm] (3){\begin{third*}{期末报告 10分}[fontupper=\itshape]
		...
		\begin{scope}
			...
			\node at (-5,-1.7) [text width=53mm] (4){\begin{fourth*}{期末考试 50分}[fontupper=\itshape]
