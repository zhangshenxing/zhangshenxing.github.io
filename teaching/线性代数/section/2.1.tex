...
\begin{frame}{例: 线性相关和线性无关}
	...
	\begin{exercise}
		...
		\begin{enumerate}
			...
			\alert{\onslide<+->{相关}} 
			\item $(a,b,1,0,0)^\rmT,(c,d,0,6,0)^\rmT,(a,c,0,5,6)^\rmT$. \alert{\onslide<+->{无关}} 
			\item $(a,1,0,b,0)^\rmT,(c,0,6,d,0)^\rmT,(a,0,5,c,6)^\rmT$. \alert{\onslide<+->{无关}} 
		\end{enumerate}
	\end{exercise}
	\onslide<+->
	\begin{exercise}
		若 $(1,0,0,2)^\rmT,(0,1,5,0)^\rmT,(2,1,t+2,4)^\rmT$ 线性相关, 则 $t=$\fillblankframe{$3$}.
	\end{exercise}
\end{frame}
