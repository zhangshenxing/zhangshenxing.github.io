\begin{frame}[<*>]{课程信息}
	\begin{itemize}
		\item 课时:
			\begin{itemize}
				\item $10$周$40$课时;
				\item 2025-09-09 $\sim$ 2025-11-13
			\end{itemize}
...
\begin{frame}{成绩构成}
	...
	\begin{tikzpicture}
		\begin{scope}
			...
			\node at (-4.9,1.7) [text width=51mm]  (1){
				\begin{main*}{作业 15分}[centerbox]\kaishu
					作业每次会提前发布, 每两周交一次.
					\alert{作业不允许迟交}.
		...
		\begin{scope}
			...
			\node at (4.4,1.8) [text width=42mm] (2){{\begin{second*}{课堂测验 25分}[centerbox]\kaishu
		...
		\begin{scope}
			...
			\node at (4.4,-1.5) [text width=42mm] (3){\begin{third*}{期末报告 10分}[centerbox]\kaishu
				完成超星各个章节的习题.
			\end{third*}};
		\end{scope}
		...
		\begin{scope}
			...
			\node at (-4.9,-1.7) [text width=51mm] (4){\begin{fourth*}{期末考试 50分}[centerbox]\kaishu
