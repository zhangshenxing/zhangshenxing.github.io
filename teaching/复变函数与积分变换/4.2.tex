...
\begin{center}
\begin{tikzpicture}
\filldraw[cstcurve,draw=dcolora,cstfill] (0,0) circle (1.2);
...
\begin{frame}[<*>]{作业}
  \begin{homeworks}
    \item(2020年B卷) 如果级数 $\displaystyle\sum_{n=0}^\infty a_n(z-1)^n$ 在点 $z=3$ 发散，则\fillbrace.
    \xx{在点 $z=-1$ 收敛}{在点 $z=-3$ 发散}{在点 $z=2$ 收敛}{以上都不对}
    \item(2020年A卷) 幂级数 $\displaystyle\sum_{n=0}^\infty(1+i)^nz^n$ 的收敛半径为\fillblank{}.
    \item(2020年B卷) 幂级数 $\displaystyle\sum_{n=1}^\infty\frac1n(z-1)^n$ 的收敛半径为\fillblank{}.
    \item(2021年B卷) 幂级数 $\displaystyle\sum_{n=1}^\infty\frac{n!}{n^n}z^n$ 的收敛半径为\fillblank{}.
    \item(2022年A卷) 幂级数 $\displaystyle\sum_{n=1}^\infty (iz)^n$ 的收敛半径是\fillbrace.
    \xx{$i$}{$-i$}{$1$}{$+\infty$}
  \end{homeworks}
\end{frame}
}
