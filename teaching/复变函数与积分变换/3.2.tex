...
\begin{frame}[<*>]{作业}
  \begin{homeworks}
		\item(2020年B卷) 设曲线 $C$ 为正向单位圆周 $|z|=1$, $|a|>1$, 则 $\displaystyle\oint_C\frac{e^z}{(z-a)^2}\diff z=$\fillblank{}.
		\item(2021年B卷) 设曲线 $C$ 为正向单位圆周 $|z|=1$, 则积分 $\displaystyle\oint_Ce^z\sin z\diff z=$\fillbrace.
		\xx{$e$}{$0$}{$e\sin 1$}{$\sin1$}
  \end{homeworks}
\end{frame}
}
