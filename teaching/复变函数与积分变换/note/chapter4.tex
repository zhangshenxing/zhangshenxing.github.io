...
\begin{exercise}
	单选题: 下列级数中发散的是\fillbrace{D}.
	\xx{$\displaystyle\sum_{n=1}^\infty\frac{i^n}{n}$}%
...
\begin{exercise}
	单选题: 级数 $\displaystyle\sum_{n=1}^\infty\left[\frac1n+\frac{(-1)^ni}{\sqrt n}\right]$ 的敛散性是\fillbrace{D}.
	\xx{无法判断}{条件收敛}{绝对收敛}{发散}
\end{exercise}
\begin{solution}[解析]
...
\begin{exercise}[3]
	判断下列级数的绝对收敛性与收敛性:
	\subex{$\displaystyle\sum_{n=2}^\infty\frac{i^n}{\ln n}$;}
	\subex{$\displaystyle\sum_{n=0}^\infty\frac{(6+5i)^n}{8^n}$;}
	\subex{$\displaystyle\sum_{n=2}^\infty\frac{n^2}{5^n}(1+2i)^n$.}
\end{exercise}
\begin{solution}
	\subex 由于它的实部级数和虚部级数
	\[-\frac1{\ln2}+\frac1{\ln4}-\frac1{\ln6}+\cdots,\quad
	-\frac1{\ln3}+\frac1{\ln5}-\frac1{\ln7}+\cdots\]
	都是交错级数, 从而条件收敛. 所以该级数\markt{条件收敛}.
...
\begin{exercise}
	单选题: 幂级数 $\displaystyle\sum_{n=1}^\infty (iz)^n$ 的收敛半径是\fillbrace{C}.
	\xx{$i$}{$-i$}{$1$}{$+\infty$}
\end{exercise}
\begin{solution}[解析]
...
\begin{exercise}
	填空题: 如果级数 $\displaystyle\sum_{n=0}^\infty a_n(z-1)^n$ 在点 $z=3$ 发散，则\fillbrace{B}.
	\xx{在点 $z=-1$ 收敛}{在点 $z=-3$ 发散}{在点 $z=2$ 收敛}{以上都不对}
\end{exercise}
\begin{solution}[解析]
...
\begin{exercise}
	填空题: 幂级数 $\displaystyle\sum_{n=0}^\infty(1+i)^nz^n$ 的收敛半径为\fillblank[2cm][3mm]{$\dfrac{\sqrt2}2$}.
\end{exercise}
\begin{solution}[解析]
...
\begin{exercise}
	填空题: 幂级数 $\displaystyle\sum_{n=1}^\infty\frac1n(z-1)^n$ 的收敛半径为\fillblank{$1$}.
\end{exercise}
\begin{solution}[解析]
...
\begin{exercise}
	填空题: 幂级数 $\displaystyle\sum_{n=1}^\infty\frac{n!}{n^n}z^n$ 的收敛半径为\fillblank{$e$}.
\end{exercise}
\begin{solution}[解析]
	根据比值法 $r=\lim\limits_{n\to\infty} \left|\dfrac{c_{n+1}}{c_n}\right|
...
\begin{exercise}[2]
	求下列幂级数的收敛半径:
	\subex{$\displaystyle\sum_{n=1}^\infty \frac{z^n}{n^p}$ ($p$ 为正整数);}
	\subex{$\displaystyle\sum_{n=1}^\infty\frac{n!}{n^n}z^n$;}
	\subex{$\displaystyle\sum_{n=0}^\infty (1+i)^n(z+i)^n$;}
	\subex{$\displaystyle\sum_{n=1}^\infty e^{\frac{\pi i}n}z^n$;}
	\subex{$\displaystyle\sum_{n=1}^\infty \left(\frac{z-2}{\ln{in}}\right)^n$;}
	\subex{$\displaystyle\sum_{n=1}^\infty(n+a^n)z^n$, 其中 $a$ 是正实数.}
\end{exercise}
\begin{solution}
	\subex 由于
...
\begin{exercise}
	函数 $f(z)=\dfrac{e^{1/z}}{z+1}$ 在 $z_0=i$ 处的泰勒展开成立的最大圆域是 $|z-i|<$\fillblank{$1$}.
\end{exercise}
\begin{solution}[解析]
...
\begin{exercise}[3]
	...
	\subex{$\dfrac1{(1+z^2)^2}$;}
	\subex{$\dfrac{1}{(z-1)(z-2)}$;}
	\subex{$e^z\cos z$.}
\end{exercise}
\begin{solution}
...
\begin{exercise}[2]
	...
	\subex{$\dfrac{z}{(z+1)(z+2)}, z_0=2$;}
	\subex{$\dfrac1{z^2}, z_0=-1$;}
	\subex{$\arctan z=−\dfrac i2\ln\dfrac{1+iz}{1-iz}, z_0=0$.}
\end{exercise}
\begin{solution}
