...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}
    ...
    \filldraw[cstcurve,second,cstfill1] (0,0) circle (\u);
  ...
  \begin{figure}[!hbt]
    ...
    \begin{tikzpicture}
      ...
      \draw[cstdash] (1,1)--(-3,1)
        ...
        node[above right] {$f\neq g$};
      \draw[cstra] (0,0)--node[above left,shift={(.2,0)}] {$1$}({cos(35)},{sin(35)});
      \draw[cstra] (0,0)--({sqrt(2)*cos(-20)},{sqrt(2)*sin(-20)}) node[right,shift={(-.1,0)}] {$\sqrt2$};
...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[xshift=40mm]
      \fill[cstfille1] (0,0) circle (1.5);
      \filldraw[cstdote,draw=main] (0,0) circle
        node[left=2pt,fill=white,inner sep=0pt] {$z_0$}
...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}
    ...
    \node[inner sep=1pt] (Z) at (-1.3,-.3) {$\zeta$};
