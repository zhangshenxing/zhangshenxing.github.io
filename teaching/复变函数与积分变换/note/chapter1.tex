...
对于一般的三次方程 $x^3+px+q=0$ 而言, 类似可得:\footnote{%
  若 $p=0$, $q>0$, 则选择 $u^3=-q/2-\sqrt{\Delta}$ 以避免 $u=0$.
}
\[
  x=u-\frac p{3u},\quad
...
\begin{figure}[!ht]
  ...
  \begin{minipage}{.32\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \fill[cstdot,main] (.35,0) circle;
      \fill[cstdot,main] (-.7,0) circle;
    \end{tikzpicture}
    \caption{$\Delta=0$}
  \end{minipage}
  \begin{minipage}{.32\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \fill[cstdot,main] (.75,0) circle;
      \fill[cstdot,main] (.15,0) circle;
      \fill[cstdot,main] (-.9,0) circle;
    \end{tikzpicture}
    \caption{$\Delta<0$}
  \end{minipage}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    \begin{scope}
      ...
      \coordinate [label=above:{$z={\color{second}x}+{\color{third}y}i$}] (A) at (2,1.5);
      \coordinate (B) at (2,0);
    ...
    \begin{scope}[xshift=5cm]
      ...
      \coordinate [label=above:{$Z(\color{second}{x},\color{third}{y})$}] (A) at (2,1.5);
      \coordinate (B) at (2,0);
      \coordinate (C) at (0,1.5);
      \draw[cstdash] (B)--(A)--(C);
      \fill[cstdot,main] (A) circle;
      \draw[decorate,decoration={brace,amplitude=5},cstfill2] (O)--(B) node[midway,above=2mm,second] {$x$};
      \draw[decorate,decoration={brace,amplitude=5},cstfill3] (C)--(O) node[midway,right=2mm,third] {$y$};
      \draw[Latex-Latex,line width=.5mm] (2.8,1)--(4,1) node[midway,below,emph] {一一对应};
      \draw[cstaxis] (-.5,0)--(3,0);
      \draw[cstaxis] (0,-.5)--(0,2.5);
    \end{scope}
    \begin{scope}[xshift=10cm]
      ...
      \draw[cstaxis] (0,-.5)--(0,2.5);
      \coordinate [label=below left:$O$] (O) at (0,0);
      \coordinate [label=above:{$\overrightarrow{OZ}=(\color{second}{x},\color{third}{y})$}] (A) at (2,1.5);
...
将复平面的 $\color{second}x$ 轴和 $\color{third}y$ 轴分别称为\noun{实轴}和\noun{虚轴}.
...
\begin{figure}[!ht]
  ...
  \begin{minipage}{.48\textwidth}
    \centering
    \begin{tikzpicture}
      \coordinate [label=above:\textcolor{second}{实轴}] (R) at (3,0);
      \coordinate [label=right:\textcolor{third}{虚轴}] (I) at (0,2.5);
      \coordinate [label=below left:$0$] (O) at (0,0);
      \coordinate [label=above:{$z={\color{second}x}+{\color{third}y}i$}] (A) at (2,1.5);
      \coordinate (B) at (2,0);
      \coordinate (C) at (0,1.5);
      ...
      \draw[decorate,decoration={brace,amplitude=5},cstfill2] (B)--(O) node[midway,below=1.5mm,second] {$\Re z$};
      \draw[decorate,decoration={brace,amplitude=5},cstfill3] (C)--(O) node[midway,right=1.5mm,third] {$\Im z$};
      \draw[cstaxis] (-.5,0)--(R);
      \draw[cstaxis] (0,-.5)--(I);
      \draw[->,thick,second] (-2,.3)-|(.6,0);
      \draw[->,thick,third] (-2,1.7)--(0,1.7);
      \draw 
        (-2,.3) node[cstnode,emph] {实数}
        (-1.7,1.7) node[align=center,cstnode] {\textcolor{main}{\bfseries 纯虚数}\\不含原点};
    \end{tikzpicture}
  \end{minipage}
  \begin{minipage}{.48\textwidth}
    \centering
    \begin{tikzpicture}
      ...
      \coordinate (I) at (0,.8);
      \draw (R) node[align=center,second] {\textcolor{main}{\bfseries 实数} \\$0,1,\sqrt2,\pi,e$};
      \draw (I) node[align=center,third] {\textcolor{main}{\bfseries 纯虚数} \\$i,-i,\pi i$};
      \draw[cstcurve] (I) circle (1.2 and .7);
      \draw 
        (3.7,0) node[align=center] {全\\体\\复\\数}
        (2.2,0) node[align=center] {虚数 \\$i,\pi i,\frac{-1+\sqrt 3 i}2$};
    \end{tikzpicture}
  \end{minipage}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \coordinate [label=below left:$0$] (O) at (0,0);
    \coordinate [label=right:\textcolor{second}{$z=x+yi$}] (Z) at (2,1);
    \coordinate [label=right:\textcolor{third}{$\ov z=x-yi$}] (Zbar) at (2,-1);
    \coordinate (R) at (2,0);
    \coordinate (I) at (0,1);
    ...
    \draw[cstcurve,cstra,third] (O)--(Zbar);
  \end{tikzpicture}
  \caption{共轭复数}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \coordinate (X) at (3,0);
    \coordinate (Y) at (0,2);
    \draw[decorate,decoration={brace,amplitude=5},cstfill3] (X)--(O) node[midway,below=2mm,third] {$x$};
    \draw[decorate,decoration={brace,amplitude=5},cstfill3] (O)--(Y) node[midway,left=2mm,third] {$y$};
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \fill[cstdot,main] (A) circle;
    \coordinate [label=above right:\textcolor{second}{$\arctan\dfrac yx$}] (B) at (.9,.9);
    \fill[cstdot,second] (B) circle;
    \coordinate [label=right:\textcolor{second}{$\arctan\dfrac yx$}] (C) at (1.4,-.9);
    \fill[cstdot,second] (C) circle;
    \coordinate [label=above left:\textcolor{third}{$\arctan\dfrac yx+\pi$}] (D) at (-1.1,.8);
    \fill[cstdot,third] (D) circle;
    \coordinate [label=below:\textcolor{main}{$\pi$}] (E) at (-.9,0);
    \fill[cstdot,main] (E) circle;
    \coordinate [label=left:\textcolor{fourth}{$\arctan\dfrac yx-\pi$}] (F) at (-1.6,-.7);
    \fill[cstdot,fourth] (F) circle;
    \coordinate [label=left:\textcolor{main}{$\dfrac\pi2$}] (G) at (0,.5);
    \fill[cstdot,main] (G) circle;
    \coordinate [label=right:\textcolor{main}{$-\dfrac\pi2$}] (H) at (0,-.6);
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[decorate,decoration={brace,amplitude=5},cstfill3] (O)--(R) node[midway,below=2mm] {$\abs{\Re z}$};
    \draw[decorate,decoration={brace,amplitude=5},cstfill3] (R)--(Z) node[midway,left=2mm] {$\abs{\Im z}$};
    \draw[cstcurve,third] (O)--(Z) node[midway,above] {$|z|$};
    ...
    \begin{scope}[cstcurve,cstra,third]
      \draw (O)--(Z1);
      \draw (Z1)--(P);
      \draw (P)--(A);
      \draw[main] (O)--(A);
...
定义 \alert{$e^{i\theta}:=\cos\theta+i\sin\theta$},\footnote{%
  $e^{i\theta}:=\cos\theta+i\sin\theta$ 叫作\noun{欧拉恒等式}, 它最先由英国数学家科茨 (Roger Cotes, 1682--1716) 于 1714 年提出\cite{Cotes1714}, 后被欧拉于 1748 年重新发现.
...
\begin{equation}\label{eq:sum-of-same-modulus}
  re^{i\theta}+re^{i\varphi}=2r\cos\frac{\theta-\varphi}2\exp\bigl(\frac{\theta+\varphi}2i\bigr).
\end{equation}
注意 $\cos\frac{\theta-\varphi}2<0$ 时, 这离指数形式还差一步变形.
...
从\thmref{定理}{thm:multiply} 可以看出, 乘以复数 $z=re^{i\theta}$ 可以理解为\alert{模放大为 $r$ 倍, 并沿逆时针旋转角度 $\theta$}.
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[cstcurve,main] pic [cstfill1,draw, "$\theta$", angle eccentricity=1.4] {angle=X--O--Z};
    \draw[cstcurve,second] pic [cstfill2,draw, "$\theta$", angle eccentricity=1.4] {angle=Z1--O--ZZ1};
    \draw[cstaxis] (-3,0)--(3,0);
    \draw[cstaxis] (0,-.5)--(0,3);
...
\begin{solution}
  ...
  因此
  \[
    z_3=\frac{3-\sqrt3}2+\frac{1-\sqrt3}2i\ \text{或}\ 
    \frac{3+\sqrt3}2+\frac{1+\sqrt3}2i.
  \]
\end{solution}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}[scale=1.6]
    ...
    \begin{scope}[cstcurve,thick,cstra,second]
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}[scale=1.6]
    ...
    \coordinate [label=below left:$0$] (O) at (0,0);
    \draw[cstcurve,thick,cstra] (0,0) circle (1);
    \coordinate[label=below right:\textcolor{second}{$1$}] (Z0) at (1,0);
    \coordinate[label=above right:\textcolor{second}{$\zeta_{12}$}] (Z1) at ({cos(30)},{sin(30)});
    \coordinate[label=above right:\textcolor{second}{$\zeta_6$}] (Z2) at ({cos(60)},{sin(60)});
    \coordinate[label=above right:\textcolor{second}{$i$}] (Z3) at ({cos(90)},{sin(90)});
    \coordinate[label=above left:\textcolor{second}{$\zeta_3$}] (Z4) at ({cos(120)},{sin(120)});
    \coordinate[label=above left:\textcolor{second}{$\zeta_{12}^5$}] (Z5) at ({cos(150)},{sin(150)});
    \coordinate[label=below left:\textcolor{second}{$-1$}] (Z6) at ({cos(180)},{sin(180)});
    \coordinate (Z7) at ({cos(210)},{sin(210)});
    \coordinate (Z8) at ({cos(240)},{sin(240)});
    \coordinate[label=below right:\textcolor{second}{$-i$}] (Z9) at ({cos(270)},{sin(270)});
    \coordinate (Z10) at ({cos(300)},{sin(300)});
    \coordinate (Z11) at ({cos(330)},{sin(330)});
    \draw[cstcurve,main] (Z0)--(Z1)--(Z2)--(Z3)--(Z4)--(Z5)--(Z6)--(Z7)--(Z8)--(Z9)--(Z10)--(Z11)--cycle;
    \draw[cstcurve,third] (Z0)--(Z2)--(Z4)--(Z6)--(Z8)--(Z10)--cycle;
    \draw[cstcurve,fourth] (Z0)--(Z3)--(Z6)--(Z9)--cycle;
    \draw[cstcurve,second] (Z0)--(Z4)--(Z8)--cycle;
  \end{tikzpicture}
  \caption{$3,4,6,12$ 次单位根}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    \begin{scope}[xshift=-6mm,yshift=-6mm]
      ...
      \draw[cstcurve,cstra,second] (A)--++(.96,.72);
      \fill[cstdot,second] (A) circle node[below] {$1+i$};
    \end{scope}
    \begin{scope}[xshift=44mm,yshift=3mm]
      ...
      \coordinate (B) at (0,.8);
      \draw[cstdash,second] (A)--(B);
      \draw[cstcurve,main] (-1.04,.88)--(.28,-1.76);
      \fill[cstdot,second] (A) circle node[below] {$-4$};
      \fill[cstdot,second] (B) circle node[right] {$2i$};
    \end{scope}
    \begin{scope}[xshift=76mm]
      \begin{scope}[rotate=30]
        ...
        \draw[cstdash,second] (A)--(Z)--(B);
      \end{scope}
      \fill[cstdot,second] (A) circle node[right] {$z_1$};
      \fill[cstdot,second] (B) circle node[left] {$z_2$};
      \draw[cstaxis] (-1.5,0)--(1.5,0);
      \draw[cstaxis] (0,-1.5)--(0,1.5);
    \end{scope}
    \begin{scope}[xshift=114mm]
      ...
      \draw[cstdash,second] (A)--(Z)--(B);
      \fill[cstdot,second] (A) circle node[below] {$z_1$};
      \fill[cstdot,second] (B) circle node[below] {$z_2$};
      \draw[cstaxis] (-1.5,0)--(1.5,0);
      \draw[cstaxis] (0,-1.5)--(0,1.5);
    \end{scope}
  \end{tikzpicture}
...
定义了一条\noun{连续曲线}\footnote{%
  这里考虑的都是连续曲线段. 如果是无限长的曲线也可类似定义连续曲线和简单曲线的概念.
}.
这也等价于 $C:z=z(t)=x(t)+iy(t),t\in[a,b]$.
如果除了两个端点有可能重叠外, 其它情形不会出现重叠的点, 则称 $C$ 是\noun{简单曲线}\footnote{%
  也叫\emph{若尔当曲线}.
  若尔当 (Marie Ennemond Camille Jordan, 1838--1922), 法国数学家.
}.

如果连续曲线 $C$ 满足两个端点重叠, 即 $z(a)=z(b)$, 则称 $C$ 是\noun{闭合曲线}.
称闭合的简单曲线为\noun{闭路}\footnote{%
  也叫\emph{简单闭曲线}或\emph{若尔当闭曲线}.
}.
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    \begin{scope}[yshift=-3mm]
      ...
      \fill[cstdot,second] (A) circle node[below] {$z(0)$};
      \fill[cstdot,second] (B) circle node[above] {$z(1)$};
    \end{scope}
    \begin{scope}[xshift=25mm]
      ...
      \coordinate (A) at (-1,-.5);
      \coordinate (B) at (1,.5);
      \fill[cstdot,second] (0,0) circle node[below right] {$z(0)$};
      \fill[cstdot,second] ({pi},0) circle node[above] {$z(2\pi)$};
    \end{scope}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \coordinate (A) at (-.7,0);
    \draw[cstcurve,third] (A) circle (.6) node[above] {$z_0$};
    \fill[cstdot,third] (A) circle;
    \coordinate (B) at (2,0);
    \draw[cstcurve,second] (B) circle (.6) node[right] {$z_0$};
    \fill[cstdot,second] (B) circle;
    \coordinate (C) at (4,0);
    \draw[cstcurve,fourth] (C) circle (.6) node[above] {$z_0$};
...
\begin{example}\delspace
  \begin{enumnopar}[(i)]
    ...
    \begin{align*}
      \BC-\{0\}&=\{z\in\BC\mid z\neq 0\},\\
      \BC-\BR_{\le0}&=\{z\in\BC\mid -\pi<\arg z<\pi\}
    \end{align*}
    的边界分别是 $\{0\}$ 以及负实轴和零的并, 它们的闭区域都是 $\BC$.
    不同的区域可以拥有相同的闭区域.
    ...
    \begin{figure}[!ht]
      ...
      \begin{tikzpicture}
        ...
        \begin{scope}[xshift=64mm,yshift=-10mm]
          ...
          \draw (1,-.5) node[below,align=center] {角状区域\footnotemark\\$\alpha_1<\arg z<\alpha_2$};
        \end{scope}
        \begin{scope}[xshift=111mm]
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[cstcurve,smooth,second] plot coordinates {(1.94,-.2) (1.79,.41) (1.23,.77) (.58,.81) (.04,.35) (-.3,-.2) (.03,-.81) (.53,-1.19) (1.23,-1.08) (1.76,-.82) (1.94,-.2)};
  \end{tikzpicture}
  \caption{多连通区域}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \end{tikzpicture}
  \begin{tikzpicture}
    \draw[cstdash,cstra,third] (-1,.7)to [bend left] (1,.7);
    \begin{scope}[xshift=-25mm]
      \draw[cstaxis] (-2,0)--(2,0);
      \draw[cstaxis] (0,-1.5)--(0,1.5);
      \begin{scope}[cstcurve,main,smooth]
        ...
        \draw[domain=-68:68]
          ...
          plot ({0.4*tan(\x)},{0.4*-sec(\x)});
      \end{scope}
      \begin{scope}[cstcurve,smooth,second,rotate=45]
        \draw (-1.2,-1.2)--(1.2,1.2);
        \draw (-1.2,1.2)--(1.2,-1.2);
        \draw[domain=-35:35]
          plot ({sec(\x)},{tan(\x)})
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}[scale=.5]
    ...
    \begin{scope}[xshift=-65mm]
      \draw[cstaxis] (-5,0)--(4,0);
      \draw[cstaxis] (0,-2.5)--(0,3.5);
      \draw
        (.5,-3) node[below] {$z$ 复平面};
      \begin{scope}[cstcurve,second]
        \draw (4,-3)--(4,3);
        \draw (3,-3)--(3,3);
        \draw (2,-3)--(2,3);
      ...
      \begin{scope}[cstcurve,main]
        \draw (1.3333,0) circle (.3333);
        \draw (1.5,0) circle (.5);
        \draw (2,0) circle (1);
        \draw (1,-3)--(1,3);
        \draw (0,0) circle (1);
        \draw (.5,0) circle (.5);
        \draw (.6667,0) circle (.3333);
      \end{scope}
    \end{scope}
    \begin{scope}[xshift=50mm]
      \draw[cstaxis] (-4,0)--(5,0);
      \draw[cstaxis] (0,-3)--(0,3);
      \draw
        (.5,-3) node[below] {$w$ 复平面};
      \begin{scope}[cstcurve,second]
        \draw (1.3333,0) circle (.3333);
        \draw (1.5,0) circle (.5);
        \draw (2,0) circle (1);
    ...
    \end{scope}
  \end{tikzpicture}
  \caption{分式线性变换 $w=\dfrac{z+1}{z-1}$}
\end{figure}

\begin{exercise}
  若分式线性变换 $\dfrac{az+b}{cz+d}$ 将圆周 $C$ 映为直线, 则 $C$ 一定经过复数\fillblank{}.
\end{exercise}

此外, 也有分别用 $\Re w$ 和 $\Im w$ 图像来表现复变函数映照的, 还有用 $|w|$ 并给不同辐角的 $w$ 涂上不同颜色来表现复变函数映照的方法.
...
可以说明, $\liml_{n\to\infty}z_n=z\in\BC$ 当且仅当对 $z$ 的任意邻域 $U$, $\exists N$ 使得当 $n\ge N$ 时 $z_n\in U$.
...
称这样的球面为\noun{复球面}, 称包含无穷远点的复平面为\noun{扩充复平面}\footnote{也叫\emph{闭复平面}.}.
若约定 $|\infty|=+\infty$, 则自然地称
\[
  U(\infty,X)=\{z\in\BC^*:|z|>X\}=\Uc(\infty,X)\cup\{\infty\}\subseteq\BC^*
\]
为 $\infty$ 的 \nouns{$X$ 邻域}{邻域!$X$ 邻域}.
% \begin{figure}[!ht]
%   \centering
...
\begin{definition}
  ...
  如果存在复数 $A$ 满足: 对 $A$ 的任意邻域 $V$, 存在 $z_0$ 的去心邻域 $\Uc$ 使得当 $z\in\Uc$ 时, $f(z)\in V$, 则称 $A$ 为 \nouns{$f(z)$ 当 $z\to z_0$ 时的极限}{极限!函数的极限}, 记为 \nouns{$\liml_{z\to z_0}f(z)$}{limzz0f(z)A@$\liml_{z\to z_0}f(z)$}$=A$ 或 \noun{$f(z)\to A (z\to z_0)$}.
\end{definition}
