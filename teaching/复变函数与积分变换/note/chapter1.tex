  ...
  \begin{minipage}{.48\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \draw 
        ...
        (2.2,0) node[align=center] {{\color{third}虚数} \\$\ii,\cpi\ii,\frac{-1+\sqrt 3\ii}2$};
    \end{tikzpicture}
  \end{minipage}
...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}
    \begin{scope}
      ...
      \draw[cstaxis] (0,-.5)--(0,2.5);
      \coordinate (O);
      \coordinate (Z1) at (1.2,1.6);
      \coordinate (Z2) at (-2.5,.5);
      \coordinate (P) at ($(Z1)+(Z2)$);
      \begin{scope}[cstcurve,cstra,fourth]
        \draw (O)--(Z1) node[above] {$z_1$};
        \draw (O)--(Z2) node[left] {$z_2$};
        \draw[main] (O)--(P) node[above left] {$z_1+z_2$};
      \end{scope}
    ...
    \begin{scope}[xshift=6cm]
      ...
      \begin{scope}[cstcurve,cstra,fourth]
        \draw (O)--(Z1) node[above] {$z_1$};
        \draw (O)--(Z2) node[left] {$z_2$};
        \draw[second] (O)--(M) node[right] {$z_1-z_2$};
      \end{scope}
...
\begin{figure}[!htb]
  \begin{minipage}{.48\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \draw[cstaxis] (axis cs:0,0,-100)--(axis cs:0,0,864) node[above] {$\Arg z$};
      \addplot3[
        surf,
        domain=0:1,
        domain y=0:720,
  ...
  \begin{minipage}{.48\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \begin{scope}[cstdot]
        \fill[main] (1.7,0) circle node[above] {$0$};
        \fill[main] (.9,.9) circle node[above right] {$\arctan\dfrac yx$};
        \fill[main] (1.4,-.9) circle node[right] {$\arctan\dfrac yx$};
        \fill[second] (-1.1,.8) circle node[above left] {$\arctan\dfrac yx+\cpi$};
        \fill[third] (-.9,0) circle node[below] {$\cpi$};
        \fill[third] (0,.5) circle node[left] {$\dfrac\cpi2$};
        \fill[third] (0,-.6) circle node[right] {$-\dfrac\cpi2$};
        \fill[fifth] (-1.6,-.7) circle node[left] {$\arctan\dfrac yx-\cpi$};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}
    \begin{scope}
      ...
      \draw[decorate,decoration={brace,amplitude=5},cstfill4] (Z)--(O) node[midway,above right] {$|z|$};
    ...
    \begin{scope}[xshift=5cm]
      \coordinate (O);
      \coordinate (Z1) at (1.4,2);
      \coordinate (Z2) at (-1.7,.4);
      \coordinate (Z3) at (-1.7,-.5);
      \coordinate (Z12) at ($(Z1)+(Z2)$);
      \coordinate (Z123) at ($(Z12)+(Z3)$);
      \coordinate (M) at ($(Z1)-(Z2)$);
      \draw[decorate,decoration={brace,amplitude=5},cstfill4] (O)--(Z1) node[midway,above,sloped] {$|z_1|$};
      \draw[decorate,decoration={brace,amplitude=5},cstfill4] (Z12)--(Z1) node[midway,above,sloped] {$|z_2|$};
      \draw[decorate,decoration={brace,amplitude=5,aspect=.6},cstfill2] (O)--(Z12) node[pos=.6,below,sloped] {$|z_1+z_2|$};
      \draw[decorate,decoration={brace,amplitude=5},cstfill4] (Z1)--(M) node[midway,above,sloped] {$|z_2|$};
      \draw[decorate,decoration={brace,amplitude=5},cstfill2] (M)--(O) node[midway,below,sloped] {$|z_1-z_2|$};
      \draw[decorate,decoration={brace,amplitude=5},cstfill4] (Z123)--(Z12) node[midway,above,sloped] {$|z_3|$};
      \draw[decorate,decoration={brace,amplitude=5,aspect=.6},cstfill2] (O)--(Z123) node[pos=.6,below,sloped] {$|z_1+z_2+z_3|$};
      \begin{scope}[cstcurve,cstra,fourth]
        \draw (O)--(Z1);
        \draw (Z1)--(Z12);
        \draw (Z12)--(Z123);
...
\begin{figure}[!htb]
  ...
  \begin{minipage}{.24\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \coordinate (A) at (\u,-\u);
      \draw[cstcurve,main] (A) circle({2*\u});
      \draw[cstra,fourth,thick] (A)--++({1.2*\u},{1.6*\u});
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[xshift=25mm]
      ...
      \begin{scope}[cstdot,fourth]
        ...
        \fill ({pi},0) circle node[above] {$z(2\cpi)$};
      \end{scope}
    \end{scope}
...
\begin{figure}[!htb]
  ...
  \begin{minipage}{.32\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \draw[cstcurve,main] (-1.5,.4)--(1.5,.4);
      \draw (0,-1.75) node[below] {$a<\Im z<b$};
    \end{tikzpicture}
    \caption{水平带状区域}
  \end{minipage}
  \begin{minipage}{.32\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \draw (1,-.75) node[below] {$\theta_1<\Arg z<\theta_2$};
    \end{tikzpicture}
...
\begin{figure}[!htb]
  ...
  \begin{tikzpicture}[scale=.5]
    ...
    \end{scope}
  \end{tikzpicture}
  \caption{分式线性映射 $w=\dfrac1z$\footnotemark}
\end{figure}
\footnotetext{为了提高各个区域的区分度, 此处未使用网格状阴影来表示无界区域.}

形如 $\dfrac{az+b}{cz+d}$ 的映射叫作\noun{分式线性映射}, 它总把直线和圆映成直线或圆.
