...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \draw[cstcurve,cstnra,third] (-1,0)-- node[above] {$w=\ee^z$} (1,0);
    \begin{scope}[shift={(-4,0)}]
      \filldraw[cstcurve,main,fill=main!60] circle (\a*\b*\b*\b);
      \filldraw[cstcurve,main,fill=main!40] circle (\a*\b*\b);
      \filldraw[cstcurve,main,fill=main!20] circle (\a*\b);
    ...
    \begin{scope}[shift={(4,0)}]
      \coordinate (O);
      \filldraw[cstcurve,fifth,fill=fifth!60] circle ({.5*\b*\b*\b+.5/\b/\b/\b} and {.5*\b*\b*\b-.5/\b/\b/\b});
      \filldraw[cstcurve,fifth,fill=fifth!40] circle ({.5*\b*\b+.5/\b/\b} and {.5*\b*\b-.5/\b/\b});
      \filldraw[cstcurve,fifth,fill=fifth!20] circle ({.5*\b+.5/\b} and {.5*\b-.5/\b});
