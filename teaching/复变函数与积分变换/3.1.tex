...
\draw[cstcurve,notcolor,smooth,domain=-35:125] plot ({1.1+1.3*cos(\x)}, {1.1+1.3*sin(\x)});
\draw[cstcurve,notcolor,smooth,domain=40:45,cstarrow1to,visible on=<3->] plot ({1.1+1.3*cos(\x)}, {1.1+1.3*sin(\x)});
\draw[cstcurve,alecolor,smooth,domain=-65:30,visible on=<5->,cstarrow1to] plot ({1.1+0.7*cos(\x)}, {1.1+0.7*sin(\x)});
\draw[cstcurve,alecolor,smooth,domain=25:120,visible on=<5->,cstarrow1to] plot ({1.1+0.7*cos(\x)}, {1.1+0.7*sin(\x)});
\draw[cstcurve,alecolor,smooth,domain=115:210,visible on=<5->,cstarrow1to] plot ({1.1+0.7*cos(\x)}, {1.1+0.7*sin(\x)});
\draw[cstcurve,alecolor,smooth,domain=205:300,visible on=<5->,cstarrow1to] plot ({1.1+0.7*cos(\x)}, {1.1+0.7*sin(\x)});
\draw (2.4,0.3) node[notcolor] {$A$};
\draw (0.4,1.9) node[notcolor] {$B$};
\fill[cstdot,notcolor] ({1.1+1.3*cos(-35)}, {1.1+1.3*sin(-35)}) circle;
\fill[cstdot,notcolor] ({1.1+1.3*cos(125)}, {1.1+1.3*sin(125)}) circle;
\end{tikzpicture}
\end{center}
\end{frame}
...
\onslide<+->
在每一段弧上任取 $\zeta_k\in\arcc{z_{k-1}z_k}$.
\onslide<+->
作和式
\[S_n=\sum_{k=1}^n f(\zeta_k)\Delta z_k,\quad
\Delta z_k=z_k-z_{k-1}.\]
\onslide<+->
设 $\Delta s_k$ 为 $\arcc{z_{k-1}z_k}$ 的长度, $\delta=\max\limits_{1\le k\le n}\Delta s_k$.
\end{definition}
\onslide<1->
\begin{center}
\begin{tikzpicture}
\draw[cstcurve,defcolor,smooth,domain=0:360] plot ({0.015*\x},{0.6*sin(\x)});
\draw[cstcurve,defcolor,smooth,domain=195:200,cstarrowto] plot ({0.015*\x},{0.6*sin(\x)});
\fill[cstdot,defcolor] (0,0) circle;
\fill[cstdot,notcolor,visible on=<3->]({0.015*32},{0.6*sin(32)}) circle;
\fill[cstdot,alecolor,visible on=<2->]({0.015*64},{0.6*sin(64)}) circle;
\fill[cstdot,notcolor,visible on=<3->]({0.015*96},{0.6*sin(96)}) circle;
\fill[cstdot,alecolor,visible on=<2->]({0.015*128},{0.6*sin(128)}) circle;
\fill[cstdot,notcolor,visible on=<3->]({0.015*160},{0.6*sin(160)}) circle;
\fill[cstdot,alecolor,visible on=<2->]({0.015*232},{0.6*sin(232)}) circle;
\fill[cstdot,notcolor,visible on=<3->]({0.015*264},{0.6*sin(264)}) circle;
\fill[cstdot,alecolor,visible on=<2->]({0.015*296},{0.6*sin(296)}) circle;
\fill[cstdot,notcolor,visible on=<3->]({0.015*328},{0.6*sin(328)}) circle;
\fill[cstdot,defcolor] ({0.015*360},0) circle;
\draw
	({0.015*32},{0.6*sin(32)-0.3}) node[notcolor,visible on=<3->] {$\zeta_1$}
	({0.015*64},{0.6*sin(64)+0.3}) node[alecolor,visible on=<2->] {$z_1$}
	({0.015*96},{0.6*sin(96)-0.3}) node[notcolor,visible on=<3->] {$\zeta_2$}
	({0.015*128},{0.6*sin(128)+0.3}) node[alecolor,visible on=<2->] {$z_2$}
	({0.015*160},{0.6*sin(160)-0.3}) node[notcolor,visible on=<3->] {$\zeta_3$}
	({0.015*232},{0.6*sin(232)+0.3}) node[alecolor,visible on=<2->] {$z_{n-2}$}
	({0.015*264},{0.6*sin(264)-0.3}) node[notcolor,visible on=<3->] {$\zeta_{n-1}$}
	({0.015*296},{0.6*sin(296)+0.3}) node[alecolor,visible on=<2->] {$z_{n-1}$}
	({0.015*328},{0.6*sin(328)-0.3}) node[notcolor,visible on=<3->] {$\zeta_n$}
	({0.015*180},{0.6*sin(180)+0.5}) node[alecolor,visible on=<2->] {$\ddots$}
  (-0.3,0) node[defcolor] {$A$}
  ({0.015*360+0.3},0) node[defcolor] {$B$};
\end{tikzpicture}
\end{center}
\end{frame}
...
&\visible<+->{=\frac12(3+4i)^2=-\frac72+12i.\quad\qedsymbol}&
\end{flalign*}
\end{solutions}
\onslide<1->
...
\draw[cstcurve,alecolor,cstarrowto](0,0)--(1.5,2);
\draw
	(-0.2,-0.2) node {$O$}
	(2.8,-0.3) node {$x$}
	(-0.2,2.3) node {$y$}
  (2.8,2) node[alecolor,align=center,visible on=<2->] {$z=(3+4i)t$\\$0\le t\le 1$};
\end{tikzpicture}
\end{frame}
...
\visible<+->{=-\frac72+12i.\quad\qedsymbol}&
\end{flalign*}
\vspace{-\baselineskip}
\end{solutions}
\onslide<1->
...
\draw[cstaxis](0,0)--(3,0);
\draw[cstaxis](0,0)--(0,2.5);
\draw[cstcurve,alecolor,domain=0:1.5,cstarrowto] plot({\x},{8*\x*\x/9});
\draw
	(-0.2,-0.2) node {$O$}
	(2.8,-0.3) node {$x$}
	(-0.2,2.3) node {$y$}
  (2.8,2) node[alecolor,align=center,visible on=<2->] {$z=t+\dfrac49it^2$\\$0\le t\le 3$};
\end{tikzpicture}
\vspace{-2pt}
\end{frame}
...
\draw[cstaxis](0,0)--(3,0);
\draw[cstaxis](0,0)--(0,2.5);
\draw[cstcurve,alecolor,cstarrowto](0,0)--(2,2);
\draw
	(-0.2,-0.2) node {$O$}
	(2.8,-0.3) node {$x$}
	(-0.2,2.3) node {$y$}
  (2.3,0.9) node[alecolor,align=center,visible on=<2->] {$z=(1+i)t$\\$0\le t\le 1$};
\end{tikzpicture}
\end{frame}
...
\onslide<+->
因此
\[\int_C\Re z\diff z=\int_0^1 t\diff t=\frac12.\qedhere\]
\onslide<2->
\vspace{-\baselineskip}
\begin{center}
\begin{tikzpicture}
\draw[cstaxis](0,0)--(3,0);
\draw[cstaxis](0,0)--(0,2.5);
\draw[cstcurve,cstarrowto,alecolor](0,0)--(0,2);
\draw[cstcurve,cstarrowto,notcolor](0,2)--(2,2);
\draw
	(-0.2,-0.2) node {$O$}
	(2.8,-0.3) node {$x$}
	(-0.2,2.3) node {$y$}
  (-1.2,1.6) node[alecolor,align=center,visible on=<3->] {$z=it$\\$0\le t\le 1$}
  (3,1.9) node[notcolor,align=center,visible on=<3->] {$z=t+i$\\$0\le t\le 1$};
\end{tikzpicture}
\end{center}
\vspace{-\baselineskip}
\end{solution}
...
\begin{columns}
	...
	\column{0.33\textwidth}
		...
		\draw[cstaxis](0,0)--(0,2.5);
		\draw[cstcurve,cstarrowto,alecolor](0,0)--(2,2);
		\draw[cstcurve,cstarrowto,notcolor](2,2)--(0,2);
		\draw
			(-0.2,-0.2) node {$O$}
			(2.3,-0.3) node {$x$}
			(-0.2,2.3) node {$y$};
...
\begin{center}
\begin{tikzpicture}
\draw[cstcurve,notcolor] ({1.3*cos(120)},{1.3*sin(120)})coordinate (C) -- (0,0)coordinate (B) --(1.3,0)coordinate (A) pic [draw,notcolor,"$\theta$",angle eccentricity=1.7,angle radius=3mm] {angle};
\draw[cstcurve,alecolor](0,0) circle (1.3);
\fill[cstdot,notcolor](0,0) circle;
\draw[cstcurve,alecolor,cstarrow1from]({1.3*cos(45)},{1.3*sin(45)}) arc (45:40:1.3);
\draw
	(-0.5,0.5) node[notcolor] {$r$}
	(0,-0.3) node[notcolor] {$z_0$};
\end{tikzpicture}
\end{center}
