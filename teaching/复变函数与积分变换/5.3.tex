...
\draw[cstcurve,alecolor] (-1.5,0) arc(180:0:1.5);
\draw[cstcurve,alecolor,cstarrowfrom] (-1.2,0.9) arc(135:130:1.5);
\draw[cstcurve,notcolor] (-1.5,0)--(1.5,0);
\draw[cstcurve,notcolor,cstarrowto] (-1.5,0)--(-0.5,0);
\draw
  (-1.5,-0.3) node[notcolor] {$-r$}
  (1.5,-0.3) node[notcolor] {$r$}
  (1.3,1.2) node[alecolor] {$C_r$};
\end{tikzpicture}
\end{center}
\end{frame}
...
%\draw[cstcurve,alecolor] (2,0)coordinate (A)--(0,0)coordinate (B)--(2,2)coordinate (C) pic [draw,notcolor,"$\frac\pi4$",angle eccentricity=1.5] {angle};
%\draw[cstcurve,alecolor] (2,0)--(2,2);
%\draw[cstcurve,alecolor,cstarrowto] (0,0)--(1.2,0);
%\draw[cstcurve,alecolor,cstarrowto] (2,0)--(2,1.2);
%\draw[cstcurve,alecolor,cstarrowto] (2,2)--(0.8,0.8);
%\draw
%  (-0.2,0.2) node {$O$}
%  (2.3,0.3) node {$R$}
%  (2.7,2) node {$R+Ri$}
%  (2.4,1) node[alecolor] {$C_1$}
%  (0.7,1.3) node[alecolor] {$C_2$};
%\end{tikzpicture}
%\end{center}
%\vspace{-2pt}
%\end{solutions}
...
\draw[cstcurve,notcolor] (-1.5,0) rectangle (1.5,1);
\draw[cstcurve,alecolor] (-1.5,0)--(-1.5,1);
\draw[cstcurve,alecolor] (1.5,0)--(1.5,1);
\draw[cstcurve,notcolor,cstarrowto] (-1.5,0)--(-0.5,0);
\draw[cstcurve,notcolor,cstarrowto] (0,1)--(-0.5,1);
\draw[cstcurve,alecolor,cstarrowto] (1.5,0)--(1.5,0.7);
\draw[cstcurve,alecolor,cstarrowto] (-1.5,1)--(-1.5,0.3);
\draw
  (1.8,0.3) node {$R$}
  (-1.9,0.3) node {$-R$}
  (0.4,0.7) node {$2\pi i$}
  (1.2,0.5) node[alecolor] {$C_1$}
  (-1.1,0.5) node[alecolor] {$C_2$}
  (-0.6,0.8) node[notcolor] {$l$};
\end{tikzpicture}
\end{center}
...
\visible<+->{I=\frac{2\pi i}{e^{p\pi i}-e^{-p\pi i}}=\frac{\pi}{\sin p\pi}.}&\visible<.->{\mqed}
\end{flalign*}
\vspace{-\baselineskip}
\end{solutionc}
\end{frame}
