...
\begin{frame}{形如 \resizet{0.9}{$\displaystyle\int_0^{2\pi} R(\cos\theta,\sin\theta)\diff\theta$} 的积分}
	\onslide<+->
...
\begin{frame}{形如 \resizet{0.9}{$\displaystyle\int_{-\infty}^{+\infty}R(x)\diff x$} 的积分}
	\onslide<+->
...
\begin{frame}{形如 \resizet{0.9}{$\displaystyle\int_{-\infty}^{+\infty}R(x)\cos{\lambda x}\diff x$,
