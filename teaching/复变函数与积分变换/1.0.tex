...
\begin{center}
	\begin{figure}[h]
		\begin{subfigure}{0.3\textwidth}
			\centering
			\begin{tikzpicture}
				\filldraw[cstcurve,dcolora,domain=-2.8:3.5,smooth,fill=white] plot ({(\x)*0.2},{(\x*\x*\x+6*\x-20)*0.02});
				\draw[cstaxis] (-1.5,0)--(1.5,0);
		...
		\begin{subfigure}{0.3\textwidth}
			\centering
			\begin{tikzpicture}
				\filldraw[cstcurve,dcolora,domain=-3.1:2.7,smooth,fill=white] plot ({(\x)*0.25},{(\x*\x*\x-3*\x+2)*0.06});
				\draw[cstaxis] (-1.5,0)--(1.5,0);
				\draw[cstaxis] (0,-1.2)--(0,1.2);
			\end{tikzpicture}
		\end{subfigure}
		\begin{subfigure}{0.3\textwidth}
			\centering
			\begin{tikzpicture}
				\filldraw[cstcurve,dcolora,domain=-3.9:3.7,smooth,fill=white] plot ({(\x)*0.2},{(\x*\x*\x-7*\x+1)*0.03});
				\draw[cstaxis] (-1.5,0)--(1.5,0);
				\draw[cstaxis] (0,-1.2)--(0,1.2);
			\end{tikzpicture}
		\end{subfigure}
