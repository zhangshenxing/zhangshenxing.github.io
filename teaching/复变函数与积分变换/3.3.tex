...
\onslide<+->
我们称之为 $f(z)$ 的\markdef{不定积分}, 记为 \markatt{$\displaystyle\int f(z)\diff z$}.
\onslide<+->
显然
...
&\visible<+->{=i\sin i+\cos i-1=e^{-1}-1.\mqed}
\end{align*}
\end{solutions}
\onslide<+->
...
&\visible<+->{=ie^{1+i}=e(-\sin 1+i\cos 1).\mqed}
\end{align*}
\end{solutions}
\endgroup
\end{frame}
...
=-\frac{\pi^2}{32}-\frac38\ln^22+\frac{\pi\ln2}{8}i.\mqed}
\end{align*}
\end{solutions}
\end{frame}
...
&\visible<+->{=\left(\frac23z^3+4z^2+z\right)\bigg|_0^{2\pi a}=\frac{16}3\pi^3a^3+16\pi^2a^2+2\pi a.\mqed}
\end{align*}
\vspace{-8pt}
\end{solutions}
\end{frame}
