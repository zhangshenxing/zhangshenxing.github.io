...
故
\begin{align*}
&\aboxeq{w=w_k=\sqrt[n]r\exp\frac{(\theta+2k\pi)i}n}\\
&\hspace{42pt}\aboxeq{=\sqrt[n]r\left(\cos\frac{\theta+2k\pi}n+i\sin\frac{\theta+2k\pi}n\right).}
\end{align*}
\onslide<+->
不难看出, $w_k=w_{k+n}$, 而 $w_0,w_1,\dots,w_{n-1}$ 两两不同.
\onslide<+->
因此只需取 \abox{$k=0,1,\dots,n-1$}.
\onslide<+->
...
\begin{columns}
	\column{0.48\textwidth}
		\begin{exercise}
		求 $\sqrt[6]{-1}$.\vphantom{$\dfrac{\sqrt3+i}2$}
