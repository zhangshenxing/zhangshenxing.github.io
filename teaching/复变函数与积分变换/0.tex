...
\begin{frame}{课程内容和学习方法}
	...
	\begin{center}
		\begin{tikzpicture}[node distance=25pt]
			\node[cstnodeg,align=center]            (1)  {\emph{课前}\\预习课本};
			\node[cstnodeg,align=center,right=of 1] (2)  {\emph{课上}\\认真听课\\记好笔记};
			\node[cstnodeg,align=center,right=of 2] (3)  {\emph{课后}\\过一遍教材\\与课上知识点};
			\node[cstnodeg,align=center,right=of 3] (4)  {\emph{作业}\\检测学\\习效果};
			\draw[cstnarrow,dcolorc] (1.east) to (2.west);
			\draw[cstnarrow,dcolorc] (2.east) to (3.west);
			\draw[cstnarrow,dcolorc] (3.east) to (4.west);
		\end{tikzpicture}
	\end{center}
\end{frame}
