...
\begin{center}
\begin{tikzpicture}
\filldraw[cstcurve,dcolora,cstfill] (0,0) circle(1);
\draw[cstcurve,cstarrowto,dcolorb] (0,0)--(0.8,0.6);
\fill[cstdot,dcolorb] (0,0) circle;
\filldraw[cstcurve,dcolora,cstfill,visible on=<3->] (3,0) circle(1);
\draw[cstcurve,visible on=<3->,cstarrowto,dcolorb] (3,0)--(3.8,0.6);
\filldraw[cstdote,visible on=<3->] (3,0) circle;
\draw
  (-0.3,0) node[dcolora,dcolorb] {$z_0$}
  (2.7,0) node[dcolora,visible on=<3->,dcolorb] {$z_0$}
  (0.5,0.1) node[dcolora,dcolorb] {$\delta$}
  (3.5,0.1) node[dcolora,visible on=<3->,dcolorb] {$\delta$};
\end{tikzpicture}
\end{center}
\end{frame}
...
\draw[cstcurve,dcolorb,smooth,visible on=<3->] plot coordinates {(4,0.5) (4.6,0.9) (5.3,2) (4.7,2.5) (3.7,2) (4.7,0.9) (5.7,0.5)};
\draw[cstcurve,dcolorc,smooth,smooth,visible on=<4->] plot coordinates {(7,1) (7.5,0.4) (8,0.2) (8.5,0.4) (9,1) (8.5,1.6) (8,1.8) (7.5,1.7) (7,1)};
\draw
