...
\onslide<+->
其中 $w=u+iv$ 的实部和虚部 \[u(x,y),\quad v(x,y)\] 是两个二元实变函数.
\onslide<+->
\begin{center}
\begin{tikzpicture}
...
\draw[cstaxis] (2.5,-1.5)--(2.5,1.5);
\draw[cstcurve,dcolora,smooth] plot coordinates {(-4,0) (-4.2,-0.4) (-2.8,-0.9) (-2,-0.7) (-1.6,0) (-1.4,1) (-2.8,1.2) (-3.2,1) (-4,0)};
\draw[cstcurve,dcolorb,smooth] plot coordinates {(4,0) (4.2,-0.4) (2.8,-0.9) (2,-0.7) (1.6,0) (1.4,1) (2.8,1.2) (3.2,1) (4,0)};
\draw[cstdash,smooth,dcolorc,cstarrowto] plot coordinates {(-2,0.8) (0,0.6) (2,0.8)};
\draw[cstdash,smooth,dcolorc,cstarrowto] plot coordinates {(-2.8,0.3) (0,-0.2) (2.8,0.3)};
\draw[cstdash,smooth,dcolorc,cstarrowto] plot coordinates {(-3.6,-0.2) (0,-0.6) (3.6,-0.2)};
\draw[cstcurve,dcolora] (-1.84,0.9)--(-3.76,-0.3);
\draw[cstcurve,dcolorb] (1.84,0.9)--(3.76,-0.3);
\fill[cstdot,dcolora] (-2,0.8) circle;
\fill[cstdot,dcolora] (-2.8,0.3) circle;
\fill[cstdot,dcolora] (-3.6,-0.2) circle;
\fill[cstdot,dcolorb] (2,0.8) circle;
\fill[cstdot,dcolorb] (2.8,0.3) circle;
\fill[cstdot,dcolorb] (3.6,-0.2) circle;
\draw
  (-0.5,0.2) node {$x$}
  (-2.7,1.5) node {$y$}
  (4.5,-0.2) node {$u$}
...
\draw[cstdash,smooth,dcolorc,cstarrowto] plot coordinates {(-2,0.8) (0,0.6) (2.02,0.3)};
\draw[cstdash,smooth,dcolorc,cstarrowto] plot coordinates {(-2.8,0.3) (0,-0.2) (2.32,-0.18)};
\draw[cstdash,smooth,dcolorc,cstarrowto] plot coordinates {(-3.6,-0.2) (0,-0.6) (2.62,-0.66)};
\draw[cstcurve,dcolora] (-1.84,0.9)--(-3.76,-0.3);
...
\draw[cstdash,smooth,dcolorc,cstarrowto] plot coordinates {(-3.1,-0.3) (-1,-0.8) (1,-0.5) (2.77,0.36)};
...
\meq[-3pt][-3pt]{x^2-y^2=c_1,\quad 2xy=c_2}
\onslide<+->{分别映射为 $w$ 平面上的两族平行直线
\meq[-3pt][-3pt]{u=c_1,\quad v=c_2.}}
...
\onslide<+->
\begin{solution}
由于 $z=\dfrac{w+1}{w-1}$, $\left|\dfrac{w+1}{w-1}\right|=2$,
\onslide<+->{因此
\[|w+1|=2|w-1|,\quad w\ov w+w+\ov w+1=4w\ov w-4w-4\ov w+4,\]}
\vspace{-\baselineskip}
\onslide<+->{
\[w\ov w-\frac53 w-\frac53\ov w+1=0,\quad \left|w-\frac53\right|^2=\dfrac{16}9,\]}
\onslide<+->{即 $\left|w-\dfrac53\right|=\dfrac43$, 是一个圆周.}
\end{solution}
\end{frame}
