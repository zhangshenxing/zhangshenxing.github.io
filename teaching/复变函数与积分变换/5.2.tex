...
\begin{tikzpicture}[node distance=25pt]
  ...
  \node[draw,white,fill=strucolor!70,right=-40pt of integral]  (integral0){定积分 $\displaystyle\int_Cf(z)\diff z$ 的计算};
