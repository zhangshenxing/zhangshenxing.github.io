...
\draw[decorate,decoration={brace,amplitude=5},dcolora,visible on =<7->] (1.6,0)--(0,0);
\draw[decorate,decoration={brace,amplitude=5},dcolorb,visible on =<7->] (0,0)--(0,1.2);
\draw
  (1.6,1.4) node[dcolora] {$z=x+yi$}
  (-0.2,-0.2) node {$0$}
  (0.7,0.8) node[dcolorc,visible on =<5->] {$r$}
  (1,-0.3) node[dcolora,visible on =<7->] {$x=r\cos\theta$}
  (-1.2,0.6) node[dcolorb,visible on =<7->] {$y=r\sin\theta$}
...
\begin{tikzpicture}[overlay,xshift=1cm,yshift=-3cm]
...
\begin{center}
	\begin{figure}[h]
		...
		\begin{subfigure}{0.45\textwidth}
			\centering
			\begin{tikzpicture}\onslide<5->
        \draw[cstaxis] (-0.5,0)--(3,0);
        \draw[cstaxis] (0,-2)--(0,1.3);
        ...
        \draw[cstdash] (2.4,0.8)--(0.8,-1.6)--(-0.8,-1.2)--(0,0);
        \draw 
          (1.8,-0.6) node[dcolora] {\small $z_1$}
          (0.6,1.3) node[dcolorb] {\small $z_2$}
          (0.75,-0.55) node[dcolora] {\small $|z_1|$}
          (2.5,0.2) node[dcolorb] {$\small |z_2|$}
          (1.4,0.8) node[dcolorc,rotate=20] {\small $|z_1+z_2|$}
          (-1.5,-0.4) node[dcolorc] {\small $|z_1-z_2|$};
			\end{tikzpicture}
		\end{subfigure}
	\end{figure}
\end{center}
