...
\begin{center}
	\begin{figure}[h]
		\begin{subfigure}{0.35\textwidth}
			\centering
			\begin{tikzpicture}
        \draw[cstaxis,visible on=<4->] (-0.3,0)--(3,0);
        \draw[cstaxis,visible on=<4->] (0,-0.3)--(0,1.5);
		...
		\begin{subfigure}{0.55\textwidth}
			\centering
			\begin{tikzpicture}
        \draw[cstaxis,visible on=<5->] (-0.5,0)--(3,0);
...
$r=|z|=\sqrt{12+4}=4$.
\onslide<+->{由于 $z$ 在第三象限,}
\onslide<+->{因此 \[\arg z=\arctan\frac{-2}{-\sqrt{12}}-\pi=\frac\pi6-\pi=-\frac{5\pi}6.\]}
\onslide<+->{故
