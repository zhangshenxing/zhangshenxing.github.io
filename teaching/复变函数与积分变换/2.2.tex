...
\end{align*}
\onslide<+->
由于 $o(\Delta z)=o(|\Delta z|)=o(\sqrt{x^2+y^2})$, 因此 \markatt{$u,v$ 可微}且
...
\begin{theorem}
函数 $f(z)$ 在 $z$ 可导当且仅当在 $z$ 点 $u,v$ 可微且满足\markatt{柯西-黎曼方程 (C-R方程)}
