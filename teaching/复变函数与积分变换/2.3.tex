...
%\fill[cstdot,dcolorc,visible on=<2->](1,1) circle;
%\draw
%	(2,1) node[visible on=<2->,dcolorc] {$z_0=1+i$}
%	(2,1.5) node[visible on=<2->,dcolorc] {$\Arg z_0=\dfrac\pi4$}
%	(-1.3,1) node[dcolorc,visible on=<3->] {$z$}
%	(-1.1,1.5) node[dcolora,visible on=<3->] {$\Arg z=\dfrac{3\pi}4$}
%	(-2.5,0.8) node[dcolorb,visible on=<4->] {$\Arg z=\dfrac{7\pi}4$};
%\fill[cstdot,dcolorc,visible on=<3->](-1,1) circle;
%\draw[cstcurve,dcolora,cstarrowto,visible on=<3->] (1,1) .. controls (0.5,2) and (-0.5,0.5).. (-1,1);
%\draw[cstcurve,dcolorb,visible on=<4->](-0.202,0.362) arc (120:420:0.4);
%\draw[cstcurve,dcolorb,visible on=<4->] (1,1)--(-0.202,0.362);
%\draw[cstcurve,dcolorb,cstarrowto,visible on=<4->] (0.202,0.362)--(-1,1);
%\draw[cstcurve,dcolorc,visible on=<7->] (0,0)to[bend left](-2,-1);
%\end{tikzpicture}
%\end{center}
%\end{frame}
...
\begin{center}
\begin{tikzpicture}
\draw[draw=white,cstfille,pattern color=dcolorb](0,0) circle (1.3);
\draw[cstaxis](-2,0)--(2,0);
\draw[cstaxis](0,-1.5)--(0,1.8);
\draw (1.8,-0.2) node {$x$};
\draw (-0.2,1.6) node {$y$};
\draw (-0.2,-0.2) node {$O$};
\draw[cstcurve,dcolora] (0,0)--(-2,0);
...
\draw (3,1.2) node[dcolora] {$w=z^{1/n}$};
\end{tikzpicture}
\end{center}
\end{frame}
