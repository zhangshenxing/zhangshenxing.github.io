...
\enumnum1 定义\emph{对数函数}
\[\Ln z=\ln\abs{z}+i\Arg z.\]
它是一个多值函数.

\enumnum2 定义\emph{对数函数主值}
\[\ln z=\ln\abs{z}+i\arg z.\]
\end{alertblock}
\onslide<+->
...
\onslide<+->{
\begin{align*}
&\peq\Ln(3-\sqrt3i)=\ln\abs{3+\sqrt 3i}+i\Arg(3-\sqrt 3i)\\
...
\draw[draw=white,cstfille](5,0) -- ({5+cos(40)},{sin(40)}) arc (40:-40:1)--(5,0);
