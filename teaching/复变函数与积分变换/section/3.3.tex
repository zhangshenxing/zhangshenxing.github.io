		...
		\begin{center}
			\begin{tikzpicture}
				...
				\draw
					...
					(1.1,0.7) node[dcolorc,visible on=<2->] {$z+\Delta z$};
			\end{tikzpicture}
		\end{center}
	...
	\begin{example}
		...
		\begin{center}
			\begin{tikzpicture}[framed]
				...
				\draw[cstcurve,dcolorb,visible on=<3>] (0,0.7) circle (0.7);
				\fill[cstdot,dcolora,visible on=<3->] (0,0) circle;
				\draw[cstcurve,dcolorb,visible on=<4>] ({0.7*(pi/180*60)},0.7) circle (0.7);
				\fill[cstdot,dcolora,visible on=<4->] ({0.7*(pi/180*60-sin(60))},{0.7*(1-cos(60))}) circle;
				\draw[cstcurve,dcolorb,visible on=<5>] ({0.7*(pi/180*120)},0.7) circle (0.7);
				\fill[cstdot,dcolora,visible on=<5->] ({0.7*(pi/180*120-sin(120))},{0.7*(1-cos(120))}) circle;
				\draw[cstcurve,dcolorb,visible on=<6>] ({0.7*(pi/180*180)},0.7) circle (0.7);
				\fill[cstdot,dcolora,visible on=<6->] ({0.7*(pi/180*180-sin(180))},{0.7*(1-cos(180))}) circle;
				\draw[cstcurve,dcolorb,visible on=<7>] ({0.7*(pi/180*240)},0.7) circle (0.7);
				\fill[cstdot,dcolora,visible on=<7->] ({0.7*(pi/180*240-sin(240))},{0.7*(1-cos(240))}) circle;
				\draw[cstcurve,dcolorb,visible on=<8>] ({0.7*(pi/180*300)},0.7) circle (0.7);
				\fill[cstdot,dcolora,visible on=<8->] ({0.7*(pi/180*300-sin(300))},{0.7*(1-cos(300))}) circle;
				\draw[cstcurve,dcolorb,visible on=<9>] ({0.7*(pi/180*360)},0.7) circle (0.7);
				\fill[cstdot,dcolora,visible on=<9->] ({0.7*(pi/180*360-sin(360))},{0.7*(1-cos(360))}) circle;
			\end{tikzpicture}
		\end{center}
		\vspace{-.5\baselineskip}
	\end{example}
