...
\begin{frame}{绝对收敛和条件收敛的判定}
	\begin{tikzpicture}[overlay]
		\draw[decorate,decoration={brace,amplitude=8},thick,dcolora] (2.3,-4.45)--(2.3,-1.45);
		\draw[decorate,decoration={brace,amplitude=8},thick,dcolorb] (4.47,-0.37)--(10.67,-0.37);
		\draw (7.57,0.2) node[dcolorb] {实部级数}
		(1.5,-3) node[align=center,dcolora] {虚\\部\\级\\数};
	\end{tikzpicture}
	\begin{center}
