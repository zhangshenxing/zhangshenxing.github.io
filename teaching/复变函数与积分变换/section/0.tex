...
\begin{frame}{成绩构成}
	...
	\begin{tikzpicture}
		...
		\begin{scope}
			...
			\node at (4.4,1.8) [text width=42mm] (2){{\begin{second*}{课堂测验 25分}
		...
		\begin{scope}
			...
			\node at (4.4,-1.5) [text width=42mm] (3){\begin{third*}{期末报告 10分}
		...
		\begin{scope}
			...
			\node at (-4.9,-1.7) [text width=51mm] (4){\begin{fourth*}{期末考试 50分}
...
\begin{frame}{课程内容关系}
	\begin{center}
		\begin{tikzpicture}[node distance=18pt]
			...
			\node[cstnode3] (51) [below=36pt of 31] {傅里叶变换};
			\node[cstnode3] (54) [right=80pt of 13] {拉普拉斯变换};
			\begin{scope}[cstmra,main]
				...
				\draw (1.west) to[bend right=20] (51.west);
			\end{scope}
		\end{tikzpicture}
	\end{center}
\end{frame}
