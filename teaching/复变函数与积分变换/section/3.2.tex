...
\begin{frame}{复合闭路定理: 注记}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw[cstcurve,dcolorb] (-1,0) circle(0.4);
			\fill[cstdot,dcolorb,visible on=<2->] (1,0) circle;
			...
			\draw
				...
				(-1,0.65) node[dcolorb,visible on=<2->] {$C_1$}
				(0,0.65) node[dcolorb,visible on=<2->] {$C_2$}
				(1,0.65) node[dcolorb,visible on=<2->] {$C_3$};
		\end{tikzpicture}
	\end{center}
\end{frame}
...
\begin{frame}{复合闭路定理: 注记}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw[cstcurve,dcolorb,visible on=<2->] (0,0) circle(1);
			...
			\draw
				...
				(-.4,0.65) node[dcolorb,visible on=<2->] {$C'$};
		\end{tikzpicture}
	\end{center}
\end{frame}
