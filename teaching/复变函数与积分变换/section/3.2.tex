...
\begin{frame}{积分路径无关与闭路积分}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw[cstcurve,third,cstarrow1to] ({2*cos(-50)},{2+2*sin(-50)}) arc(-50:-45:2);
			\draw[cstcurve,main] (0,0) arc(180:90:2);
			\draw[cstcurve,main,cstarrow1to] ({2+2*cos(140)},{2*sin(140)}) arc(140:135:2);
			\draw[cstcurve,second,cstarrow1from,visible on=<2->] ({1+0.3*cos(135)},{1+0.3*sin(135)}) arc(135:-110:0.3);
		\end{tikzpicture}
	\end{center}
\end{frame}
...
\begin{frame}{柯西-古萨基本定理}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw[cstcurve,main,smooth,domain=-20:45,cstarrow1from] plot({3*sqrt(cos(2*\x))*cos(\x)},{3*sqrt(cos(2*\x))*sin(\x)});
			\draw[cstcurve,main,smooth,domain=-45:-15] plot({-2*sqrt(cos(2*\x))*cos(\x)},{2*sqrt(cos(2*\x))*sin(\x)});
			\draw[cstcurve,main,smooth,domain=-20:45,cstarrow1from] plot({-2*sqrt(cos(2*\x))*cos(\x)},{2*sqrt(cos(2*\x))*sin(\x)});
			\draw[cstcurve,second,cstarrow1from,ultra thick] (1.05,0.35) arc (135:-135:0.5);
			\draw[cstcurve,third,cstarrow1from,ultra thick] (-0.75,-0.25) arc (315:45:0.3535);
		\end{tikzpicture}
	\end{center}
\end{frame}
...
\begin{frame}{典型例题: 柯西-古萨基本定理计算积分}
	...
	\begin{exercise}
		\begin{enumerate}
			\item $\displaystyle\oint_{|z-2|=1}\frac1{z^2+z}\diff z=$\fillblank{\visible<5->{$0$}}.
			\item 求 $\displaystyle\oint_{|z|=2}\dfrac{\sin z}{|z|}\diff z=$\fillblank{\visible<6->{$0$}}.
		\end{enumerate}
	\end{exercise}
\end{frame}
...
\begin{frame}{多连通域边界与复合闭路}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw[cstcurve,main] (-1,0) circle(0.6);
			\draw[cstcurve,main,domain=85:90,cstarrow1to,visible on=<2->] plot ({2.5*cos(\x)}, {1.5*sin(\x)});
			\draw[cstcurve,main,domain=135:140,cstarrow1from,visible on=<2->] plot ({1+0.6*cos(\x)}, {0.6*sin(\x)});
			\draw[cstcurve,main,domain=135:140,cstarrow1from,visible on=<2->] plot ({-1+0.6*cos(\x)}, {0.6*sin(\x)});
			\draw
				(2,1.3) node[main] {$C_0$}
...
\begin{frame}{复合闭路定理}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw[cstcurve,main] (1,0) circle(0.6);
			\draw[cstcurve,main] (-1,0) circle(0.6);
			\draw[cstcurve,main,domain=85:90,cstarrow1to] plot ({2.5*cos(\x)}, {1.5*sin(\x)});
			\draw[cstcurve,main,domain=135:140,cstarrow1from] plot ({1+0.6*cos(\x)}, {0.6*sin(\x)});
			\draw[cstcurve,main,domain=135:140,cstarrow1from] plot ({-1+0.6*cos(\x)}, {0.6*sin(\x)});
			\draw
				(2,1.3) node[main] {$C_0$}
				(-1,0.85) node[main] {$C_1^{\visible<2->-}$}
	...
	\begin{proof}
		...
		\begin{center}
			\begin{tikzpicture}[framed,scale=.9]
				...
				\draw[cstcurve,main,domain=0:90,cstarrow1to] plot ({2.5*cos(\x)}, {1.5*sin(\x)});
				\draw[cstcurve,main,domain=85:180] plot ({2.5*cos(\x)}, {1.5*sin(\x)});
				\draw[cstcurve,second,domain=180:270,cstarrow1to] plot ({2.5*cos(\x)}, {1.5*sin(\x)});
				\draw[cstcurve,second,domain=265:360] plot ({2.5*cos(\x)}, {1.5*sin(\x)});

				\draw[cstcurve,main,domain=0:140] plot ({1+0.6*cos(\x)}, {0.6*sin(\x)});
				\draw[cstcurve,main,domain=135:180,cstarrow1from] plot ({1+0.6*cos(\x)}, {0.6*sin(\x)});
				\draw[cstcurve,second,domain=180:320] plot ({1+0.6*cos(\x)}, {0.6*sin(\x)});
				\draw[cstcurve,second,domain=315:360,cstarrow1from] plot ({1+0.6*cos(\x)}, {0.6*sin(\x)});
...
\begin{frame}{复合闭路定理: 注记}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw[cstcurve,second] (-1,0) circle(0.4);
			\fill[cstdot,second,visible on=<2->] (1,0) circle;
	...
	\begin{example}
		...
		\begin{center}
			\begin{tikzpicture}[framed]
				...
				\draw[cstcurve,cstarrow1to,main] (-1,-0.7)--(-0.5,-0.7);
				\draw[cstcurve,cstarrow1to,second] (-0.4,0) arc(180:225:0.4);
				\draw[cstcurve,cstarrow1to,second] (0.6,0) arc(180:225:0.4);
	...
	\begin{example}
		...
		\begin{center}
			\begin{tikzpicture}[scale=.8,framed]
				...
				\draw[cstcurve,main,cstarrow1from] (-1.06,1.06) arc(135:90:1.5);
				\filldraw[cstcurve,second,fill=white] (0,0) circle (0.75);
				\draw[cstcurve,second,cstarrow1to] (-0.75,0) arc(180:130:0.75);
				\draw
