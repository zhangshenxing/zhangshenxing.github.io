	...
	\begin{center}
		\begin{tikzpicture}
			...
			\begin{scope}[xshift=18mm,yshift=11mm,second,cstdot,cstcurve,smooth]
				...
				\fill (B) circle;
			\end{scope}
			\begin{scope}[xshift=-14mm,yshift=11mm,cstcurve,main,smooth,cstwla,visible on=<5->]
	...
	\begin{solution}
		...
		\begin{center}
			\begin{tikzpicture}
				...
				\draw[cstcurve,main,cstwra](0,0)--(1.5,2);
				\draw
...
\begin{frame}{典型例题: 计算复变函数沿曲线的积分}
	...
	\begin{solution}
		...
		\onslide<+->{%
			...
			\begin{flalign*}
				...
				&\visible<+->{=\int_0^3\biggl(t+\frac43it^2-\frac{32}{81}t^3\biggr)\diff t}&\\
				&\visible<+->{=\biggl(\half t^2+\frac49it^3-\frac8{81}t^4\biggr)\Big|_0^3}
				\visible<+->{=-\frac72+12i.}&
		\end{flalign*}}
		\vspace{-\baselineskip}
	\end{solution}
	\vspace{-\baselineskip}
	\onslide<1->
	\begin{tikzpicture}[overlay,xshift=85mm,yshift=10mm]
		\draw[cstaxis](0,0)--(3,0);
		\draw[cstaxis](0,0)--(0,2.5);
	...
	\begin{solution}
		...
		\begin{center}
			\begin{tikzpicture}
				...
				\draw[cstcurve,main,cstwra](0,0)--(2,2);
				\draw
	...
	\begin{solution}
		...
		\begin{center}
			\begin{tikzpicture}
				...
				\draw[cstaxis](0,0)--(0,2);
				\draw[cstcurve,main,cstwra](0,0)--(0,1.5);
				\draw[cstcurve,second,cstwra](0,1.5)--(1.5,1.5);
				\draw
					(-1.1,1.2) node[align=center,main,visible on=<3->] {$z=it$\\$0\le t\le 1$}
					(2.5,1.5) node[align=center,second,visible on=<3->] {$z=t+i$\\$0\le t\le 1$};
			\end{tikzpicture}
		\end{center}
	...
	\begin{exercise}
		...
		\begin{center}
			\begin{tikzpicture}[scale=.8]
				\draw[cstaxis](0,0)--(2.5,0);
				\draw[cstaxis](0,0)--(0,2.5);
				\draw[cstcurve,cstwra,main](0,0)--(2,2);
				\draw[cstcurve,cstwra,second](2,2)--(0,2);
			\end{tikzpicture}
		\end{center}
	\end{exercise}
\end{frame}
	...
	\begin{proof}
		...
		\onslide<+->{%
			...
			\begin{align*}
				...
				\visible<+->{=}&\visible<.->{\abs{\oint_{|z-a|=r}\frac{(z-a)f(z)-k}{z-a}\diff z}}
