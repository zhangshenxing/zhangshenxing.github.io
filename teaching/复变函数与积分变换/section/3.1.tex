...
\begin{frame}{有向曲线}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw[cstcurve,second,smooth,domain=-35:125] plot ({1.4+1.3*cos(\x)}, {1.1+1.3*sin(\x)});
			\draw (3.4,0.3) node[second] {$A=z(a)$};
			\draw (0.8,1.9) node[second] {$B=z(b)$};
			\fill[cstdot,second] ({1.4+1.3*cos(-35)}, {1.1+1.3*sin(-35)}) circle;
			\fill[cstdot,second] ({1.4+1.3*cos(125)}, {1.1+1.3*sin(125)}) circle;
			\draw[cstcurve,second,smooth,domain=40:45,cstarrow1to,visible on=<3->] plot ({1.4+1.3*cos(\x)}, {1.1+1.3*sin(\x)});
			\draw[cstcurve,main,smooth,domain=-65:30,visible on=<5->,cstarrow1to] plot ({-1.4+0.7*cos(\x)}, {1.4+0.7*sin(\x)});
			\draw[cstcurve,main,smooth,domain=25:120,visible on=<5->,cstarrow1to] plot ({-1.4+0.7*cos(\x)}, {1.4+0.7*sin(\x)});
			\draw[cstcurve,main,smooth,domain=115:210,visible on=<5->,cstarrow1to] plot ({-1.4+0.7*cos(\x)}, {1.4+0.7*sin(\x)});
			\draw[cstcurve,main,smooth,domain=205:300,visible on=<5->,cstarrow1to] plot ({-1.4+0.7*cos(\x)}, {1.4+0.7*sin(\x)});
		\end{tikzpicture}
	\end{center}
\end{frame}
...
\begin{frame}{复变函数积分的定义}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\fill[cstdot,second,visible on=<3->]({0.015*32},{0.6*sin(32)}) circle;
			\fill[cstdot,main,visible on=<2->]({0.015*64},{0.6*sin(64)}) circle;
			\fill[cstdot,second,visible on=<3->]({0.015*96},{0.6*sin(96)}) circle;
			\fill[cstdot,main,visible on=<2->]({0.015*128},{0.6*sin(128)}) circle;
			\fill[cstdot,second,visible on=<3->]({0.015*160},{0.6*sin(160)}) circle;
			\fill[cstdot,main,visible on=<2->]({0.015*232},{0.6*sin(232)}) circle;
			\fill[cstdot,second,visible on=<3->]({0.015*264},{0.6*sin(264)}) circle;
			\fill[cstdot,main,visible on=<2->]({0.015*296},{0.6*sin(296)}) circle;
			\fill[cstdot,second,visible on=<3->]({0.015*328},{0.6*sin(328)}) circle;
			\fill[cstdot,third] ({0.015*360},0) circle;
			\draw
			({0.015*32},{0.6*sin(32)-0.3}) node[second,visible on=<3->] {$\zeta_1$}
			({0.015*64},{0.6*sin(64)+0.3}) node[main,visible on=<2->] {$z_1$}
			({0.015*96},{0.6*sin(96)-0.3}) node[second,visible on=<3->] {$\zeta_2$}
			({0.015*128},{0.6*sin(128)+0.3}) node[main,visible on=<2->] {$z_2$}
			({0.015*160},{0.6*sin(160)-0.3}) node[second,visible on=<3->] {$\zeta_3$}
			({0.015*232},{0.6*sin(232)+0.3}) node[main,visible on=<2->] {$z_{n-2}$}
			({0.015*264},{0.6*sin(264)-0.3}) node[second,visible on=<3->] {$\zeta_{n-1}$}
			({0.015*296},{0.6*sin(296)+0.3}) node[main,visible on=<2->] {$z_{n-1}$}
			({0.015*328},{0.6*sin(328)-0.3}) node[second,visible on=<3->] {$\zeta_n$}
			({0.015*180},{0.6*sin(180)+0.5}) node[main,visible on=<2->] {$\ddots$}
			(-0.3,0) node[third] {$A$}
...
\begin{frame}{典型例题: 计算复变函数沿曲线的积分}
	...
	\begin{solution}
		...
		\[
			...
			\visible<+->{=\half (3+4i)^2=-\frac72+12i.}
		\]}
		\vspace{-\baselineskip}
	\end{solution}
	\onslide<1->
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw
				(2.5,1.2) node[main,align=center,visible on=<2->] {$z=(3+4i)t$\\$0\le t\le 1$};
		\end{tikzpicture}
	\end{center}
\end{frame}
...
\begin{frame}{典型例题: 计算复变函数沿曲线的积分}
	...
	\begin{solution}
		...
		\begin{flalign*}
			...
			&\visible<+->{=\left(\half t^2+\frac49it^3-\frac8{81}t^4\right)\Big|_0^3}
			\visible<+->{=-\frac72+12i.}&
		\end{flalign*}}
		\vspace{-\baselineskip}
	\end{solution}
	...
	\begin{tikzpicture}[overlay]\begin{tikzpicture}[framed,xshift=-80mm,yshift=-5mm]
		...
		\draw
			(2.8,2) node[main,align=center,visible on=<2->] {$z=t+\dfrac49it^2$\\[1mm]$0\le t\le 3$};
...
\begin{frame}{典型例题: 计算复变函数沿曲线的积分}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw
				(2.4,0.9) node[main,align=center,visible on=<2->] {$z=(1+i)t$\\$0\le t\le 1$};
		\end{tikzpicture}
	\end{center}
\end{frame}
	...
	\begin{solution}
		...
		\begin{center}
			\begin{tikzpicture}[framed]
				...
				\draw
					(-1.1,1.2) node[main,align=center,visible on=<3->] {$z=it$\\$0\le t\le 1$}
					(2.5,1.5) node[second,align=center,visible on=<3->] {$z=t+i$\\$0\le t\le 1$};
			\end{tikzpicture}
		\end{center}
...
\begin{frame}{例题: 计算复变函数沿圆周的积分}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw[cstcurve,main,cstarrow1from]({1.3*cos(45)},{1.3*sin(45)}) arc (45:-320:1.3);
			\draw
