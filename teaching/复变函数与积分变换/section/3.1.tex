...
\begin{frame}{典型例题: 计算复变函数沿曲线的积分}
	...
	\onslide<+->
	\begin{exercise}
		求 $\displaystyle\int_C\Im z\diff z=$\fillblank[3cm][2mm]{\onslide<+->{$-\dfrac12+\dfrac i2$}}, 其中 $C$ 是从原点沿 $y=x$ 到点 $1+i$ 再到 $i$ 的折线段.
		\begin{center}
...
\begin{frame}{例: 计算复变函数沿圆周的积分}
	...
	\begin{solution}
		...
		\onslide<+->{%
			...
			\begin{align*}
				\alert<8->{\oint_C\frac{\diff z}{(z-z_0)^{n+1}}}
