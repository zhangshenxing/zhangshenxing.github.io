...
\begin{frame}{典型例题: 计算复变函数沿曲线的积分}
	...
	\onslide<1->
	\begin{tikzpicture}[overlay]\begin{tikzpicture}[framed,xshift=-75mm,yshift=-36mm]
...
\begin{frame}{典型例题: 计算复变函数沿曲线的积分}
	...
	\onslide<1->
	\begin{tikzpicture}[overlay]\begin{tikzpicture}[framed,xshift=-80mm,yshift=-35mm]
		\draw[cstaxis](0,0)--(3,0);
		\draw[cstaxis](0,0)--(0,2.5);
...
\begin{frame}{典型例题: 计算复变函数沿曲线的积分}
	...
	\onslide<1->
	\begin{tikzpicture}[overlay]\begin{tikzpicture}[framed,xshift=-80mm,yshift=-32mm]
		\draw[cstaxis](0,0)--(3,0);
		\draw[cstaxis](0,0)--(0,2.5);
...
\begin{frame}{典型例题: 计算复变函数沿曲线的积分}
	...
	\begin{solution}
		...
		\onslide<+->{第二段 $z=t+i$, $0\le t\le 1$, $\Re z=t$.
			...
			\[\int_C\Re z\diff z=\int_0^1 t\diff t=\half .\]}
		\onslide<2->
...
\begin{frame}{例题: 计算复变函数沿圆周的积分}
	...
	\end{solution}
	\onslide<2->
	\begin{tikzpicture}[overlay]\begin{tikzpicture}[framed,xshift=-85mm,yshift=-25mm]
