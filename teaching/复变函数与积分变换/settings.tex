...
% \NewDocumentCommand\fillblank{O{2cm} O{0.4cm} m}{\uline{\makebox[#1]{\vphantom{\rule{0pt}{#2}#3}#3}}}%
\NewDocumentCommand\fillblank{O{0.4cm} m}{\underline{\hspace{#1}\alert{#2}\hspace{#1}}}%
% TIKZ 设置
\usetikzlibrary{
	quotes,
	shapes.arrows,
