...
\textbf{1.} \fillblankframe[2.5cm]{$e^{\pi/2}$}, 
\textbf{2.} \fillblankframe[2.5cm]{$1$}, 
\textbf{3.} \fillblankframe[2.5cm]{$0$}, 
\textbf{4.} \fillblankframe[2.5cm]{$2$}, 
\textbf{5.} \fillblankframe[2.5cm]{$2\pi j\delta(\omega+1)$}.
...
\textbf{1.} \fillblankframe[2.5cm]{$\dfrac{2\pi}3$}, 
\textbf{2.} \fillblankframe[2.5cm]{$0$}, 
\textbf{3.} \fillblankframe[2.5cm]{$-1$}, 
\textbf{4.} \fillblankframe[2.5cm]{$2\pi i$}, 
\textbf{5.} \fillblankframe[2.5cm]{$2\pi\delta(\omega-1)$}.
...
\textbf{1.} \fillblankframe[2cm]{$-\ln 2$}, 
\textbf{2.} \fillblankframe[2.5cm]{$1+2023i$}, 
\textbf{3.} \fillblankframe[1.7cm]{$\pi$}, 
\textbf{4.} \fillblankframe[1.7cm]{$0$}, 
\textbf{5.} \fillblankframe[4.5cm]{$\pi[\delta(\omega+3)+\delta(\omega-3)]$}.
...
\textbf{1.} \fillblankframe[2.5cm]{$-\dfrac34\pi$}, 
\textbf{2.} \fillblankframe[2.5cm]{$-i$}, 
\textbf{3.} \fillblankframe[2.5cm]{$3$}, 
\textbf{4.} \fillblankframe[2.5cm]{$0$}, 
\textbf{5.} \fillblankframe[2.5cm]{$2\delta(t)$}.
...
\textbf{4. （10分） 【解】}
由于 $f(z)=\dfrac{\sin z+2z}{(z+\pi)^2}$ 在 $|z-1|\le 4$ 内的奇点为 $-\pi$, \score2\\
因此
\begin{align*}
