...
\textbf{1.} \fillblank[2.5cm]{$-\dfrac34\pi$}, 
\textbf{2.} \fillblank[2.5cm]{$-i$}, 
\textbf{3.} \fillblank[2.5cm]{$3$}, 
\textbf{4.} \fillblank[2.5cm]{$0$}, 
\textbf{5.} \fillblank[2.5cm]{$2\delta(t)$}.
...
\item 下面哪个数不是纯虚数?(~~~~)
\xx{$\ln(-1)$}{$\cos i$}{$\sin i$}{$\sqrt{-\pi}$ 主值}
...
\textbf{2.} \fillblank[2.5cm]{$-\frac{\pi i}2$}, 
\textbf{3.} \fillblank[1.7cm]{$2\pi i$}, 
...
\textbf{7. （10分） 【解】}
由于 $0$ 是分母的二阶零点, 因此它是 $f(z)$ 的二阶极点. \score1\\
由于 $\pm\pi$ 是分子分母的一阶零点, 因此它是 $f(z)$ 的可去极点. \score1\\
对于整数 $k\neq 0,\pm1$, $k\pi$ 是分母的一阶零点, 因此它是 $f(z)$ 的一阶极点. \score1
\[\Res[f(z),\pi]=0,\score1\]
