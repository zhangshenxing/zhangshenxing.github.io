...
% 非考试内容
\newcommand{\noexer}{\hfill\itshape\color{black}\small 非考试内容}
% 枚举数字引用标志
...
\newcommand\mqed{\visible<.->{\qedsymbol}} % 手动证毕标志
...
\tikzset{
	...
	cyanbg/.style={background rectangle/.style={semithick,fill=cyan!10,draw=cyan,rounded corners}},
	...
	cstnarrow/.style      ={-Latex, line width=1mm}, %文本框间箭头
	cstaxis/.style        ={-Stealth, thick}, %坐标轴
	cstcurve/.style       ={very thick}, %一般曲线
	cstdash/.style        ={thick, dash pattern= on 2mm off 0.5mm}, %虚线
	...
	cstnode/.style        ={fill=white,draw=black,text=black,rounded corners=2mm,line width=1pt},
	cstnodeb/.style       ={fill=lightb,draw=heavyb,text=black,rounded corners=2mm,line width=1pt},
	cstnodeg/.style       ={fill=lightg,draw=heavyg,text=black,rounded corners=2mm,line width=1pt},
	cstnoder/.style       ={fill=lightr,draw=heavyr,text=black,rounded corners=2mm,line width=1pt}
}
% 标题
\author{张神星}
\institute{合肥工业大学}
