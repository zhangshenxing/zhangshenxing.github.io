...
\begin{frame}{常数函数}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\draw[cstcurve,main] (-3,1)--(3,1);
			\draw
				(-0.2,-0.2) node {$O$}
				 (2.8,-0.2) node {$x$}
				(-0.2, 1.8) node {$y$}
				(-0.2, 0.8) node {$C$}
				( 1.8, 1.3) node[main] {$y=C$};
		\end{tikzpicture}
	\end{center}
\end{frame}
...
\begin{frame}{指数函数}
	...
	\begin{itemize}
		...
		\item $y=a^x$ 的图像和 $y=(1/a)^x$ 的图像关于 $y$ 轴对称.
		\item 当 $a=1$ 时, 它退化为常数函数 $y=1$.
		\item 直线 $y=0$ 是它唯一的渐近线.
	\end{itemize}
	\onslide<2->
	\begin{center}
		\begin{tikzpicture}[inner frame ysep=0.5ex]
			\draw[cstaxis] (-3,0)--(3,0);
			\draw[cstaxis] (0,-0.4)--(0,2.3);
			\begin{scope}[cstcurve,smooth,domain=-3:1.2]
				\draw[main] plot (\x,{2^\x});
				\draw[second] plot (-\x,{2^\x});
			\end{scope}
			\draw
				(-0.2,-0.2) node {$O$}
				( 2.8,-0.2) node {$x$}
				(-0.2, 2.1) node {$y$}
				( 2.2, 1.5) node[main] {$y=a^x (a>1)$}
				(-2.6, 1.5) node[second] {$y=a^x (0<a<1)$};
			\begin{scope}[visible on=<4->]
				\fill[cstdot,fifth]	(0,1) circle;
...
\begin{frame}{对数函数}
	...
	\end{definition}	
	\onslide<+->
	\begin{tikzpicture}[overlay]\begin{tikzpicture}[xshift=-72mm,yshift=26mm]
		\draw[cstaxis] (-0.5,0)--(3.5,0);
		\draw[cstaxis] (0,-2.3)--(0,2.3);
		\begin{scope}[cstcurve,smooth,domain=-2.3:1.5]
			\draw[main] plot ({2^\x},\x);
			\draw[second] plot ({2^\x},-\x);
		\end{scope}
		\draw
			(-0.2,-0.2) node {$O$}
			( 3.3,-0.2) node {$x$}
			(-0.2, 2.1) node {$y$}
			( 2.0,-1.9) node[main] {$y=\log_ax (a>1)$}
			( 2.3, 1.9) node[second] {$y=\log_ax (0<a<1)$};
	...
	\begin{itemize}
		...
		\item $y=\log_a x$ 的图像和 $y=\log_{1/a}	x$ 的图像\\
		关于 $x$ 轴对称.\vspace{8mm}
...
\begin{frame}{幂函数: 正有理幂次 $\frac pq$, $p,q$ 奇}
	...
	\onslide<5->{
	\begin{tikzpicture}[overlay]\begin{tikzpicture}[xshift=-37mm,yshift=25mm]
		\draw[cstaxis] (-2.3,0)--(2.3,0);
		\draw[cstaxis] (0,-2.3)--(0,2.3);
		\begin{scope}[cstcurve,smooth,domain=-1.3:1.3]
			\draw[main] plot (\x,{\x^3});
			\draw[second] plot ({\x^3},\x);
		\end{scope}
		\draw[cstdash,fourth,visible on=<8->] (-2,-2)--(2,2);
		\draw
			(-0.2, 0.2) node {$O$}
			( 2.1,-0.2) node {$x$}
			(-0.2, 2.1) node {$y$}
			(0.65, 2.0) node[main] {$y=x^3$}
			(-2.8,-1.3) node[second] {$y=x^{\frac13}$};
		\begin{scope}[visible on=<7->]
			\draw[cstdash,fifth] (1,0)--(1,1)--(0,1) (-1,0)--(-1,-1)--(0,-1);
...
\begin{frame}{幂函数: 正有理幂次 $\frac pq$, $p,q$ 一奇一偶}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\draw[cstcurve,main,smooth,domain=-1.5:1.5] plot (\x,{\x*\x});
			\draw[cstdash,fourth,visible on=<9->] (-0.4,-0.4)--(2,2);
			\draw
				( 0.2,-0.2) node {$O$}
				( 2.1,-0.2) node {$x$}
				(-0.2, 2.1) node {$y$}
				(-1.9, 1.5) node[main] {$y=x^2$};
			\begin{scope}[second,visible on=<6->]
			...
			\begin{scope}[visible on=<4->]
				\draw
					...
					(-1.0,-0.2) node {$-1$}
					(-0.2, 1.2) node {$1$};
				\draw[cstdash,fifth] (-1,0)--(-1,1)--(1,1)--(1,0);
				\begin{scope}[cstdot,fifth]
					\fill	(1,1) circle;
					\fill	(-1,1) circle;
					\fill	(0,0) circle;
...
\begin{frame}{幂函数: 负有理幂次 $\frac pq$, $p,q$ 奇}
	\onslide<2->
	\begin{tikzpicture}[overlay]\begin{tikzpicture}[xshift=-45mm,yshift=40mm]
		\draw[cstaxis] (-2.8,0)--(2.8,0);
		\draw[cstaxis] (0,-2.8)--(0,2.8);
		\begin{scope}[cstcurve,main,smooth,domain=0.4:1.4]
			\draw plot ({1/\x},{\x^3});
			\draw plot ({-1/\x},{-\x^3});
		\end{scope}
		\begin{scope}[visible on=<6->]
			\begin{scope}[cstcurve,second,smooth,domain=0.4:1.4]
				\draw plot ({\x^3},{1/\x});
				\draw plot ({-\x^3},{-1/\x});
			\end{scope}
			\draw[cstdash,fourth] (-2,-2)--(2,2);
			\draw (2.2,1.2) node[second] {$y=x^{-\frac13}$};
		\end{scope}
		\draw
			(0.2,-0.2) node {$O$}
			(2.6,-0.2) node {$x$}
			(-0.2,2.6) node {$y$}
			(-1.6,-2.2) node[main] {$y=x^{-3}$};
		\begin{scope}[visible on=<4->]
			\draw
				( 1.0,-0.2) node {$1$}
				(-1.0, 0.2) node {$-1$}
...
\begin{frame}{幂函数: 负有理幂次 $\frac pq$, $p,q$ 一奇一偶}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\begin{scope}[cstcurve,main,smooth,domain=0.5:1.6]
				\draw plot ({1/\x},{\x*\x});
				\draw plot ({-1/\x},{\x*\x});
			\end{scope}
			\begin{scope}[visible on=<6->,second]
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\begin{scope}[cstcurve,smooth]
				\begin{scope}[main,domain=0:1.9]
					\draw plot (\x,{\x^(sqrt 3)});
					\draw plot ({\x^(sqrt 3)},\x);
				\end{scope}
				\begin{scope}[second,domain=0.3:1.9]
			...
			\draw
				...
				( 3.2,-0.2) node {$x$}
				(-0.2, 3.2) node {$y$}
				( 2.7, 3.2) node[main] {$y=x^{\sqrt 3}$}
				( 3.8, 2.3) node[main] {$y=x^{\frac1{\sqrt 3}}$}
				( 4.3, 0.3) node[second] {$y=x^{-\sqrt 3}$}
				( 4.0, 0.8) node[second] {$y=x^{-\frac1{\sqrt 3}}$};
			\draw[cstdash,fourth,visible on=<5->] (-0.4,-0.4)--(3,3);
			\begin{scope}[visible on=<4->]
				\draw
					(1,-0.2) node {$1$}
					(-0.2,1) node {$1$};
				\draw[cstdash,fifth] (0,1)--(1,1)--(1,0);
				\fill[cstdot,fifth]	(1,1) circle;
			\end{scope}
		\end{tikzpicture}
	\end{center}
\end{frame}
...
\begin{frame}{幂函数性质总结}
	...
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|}\hline
			\tht $\mu=\dfrac pq$   &\tht $(-\infty,0)$&\tht $0$ &\tht $(0,+\infty)$&\tht 值域\\\hline
			$\mu>0$, $q$ 奇, $p$ 奇&$\nearrow$&$0$&$\nearrow$&$(-\infty,+\infty)$\\\hline
			$\mu>0$, $q$ 奇, $p$ 偶&$\searrow$&$0$&$\nearrow$&$[0,+\infty)$\\\hline
			$\mu>0$, $q$ 偶        &无定义    &$0$&$\nearrow$&$[0,+\infty)$\\\hline
			$\mu>0$ 为无理数       &无定义    &$0$&$\nearrow$&$(0,+\infty)$\\\hline			
			$\mu<0$, $q$ 奇, $p$ 奇&$\searrow$&无定义&$\searrow$&$(-\infty,0)\cup(0,+\infty)$\\\hline
			$\mu<0$, $q$ 奇, $p$ 偶&$\nearrow$&无定义&$\searrow$&$(0,+\infty)$\\\hline
			$\mu<0$, $q$ 偶        &无定义    &无定义&$\searrow$&$(0,+\infty)$\\\hline
			$\mu<0$ 为无理数       &无定义    &无定义&$\searrow$&$(0,+\infty)$\\\hline
		\end{tabular}}
	\end{center}
\end{frame}
...
\begin{frame}{三角函数}
	...
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|c|}\hline
			...
			正切 $\tan x$&$x\neq \bigl(k+\half\bigr)\pi, k\in\BZ$&$(-\infty,+\infty)$&无界&$\pi$&奇函数\\\hline
			余切 $\cot x$&$x\neq k\pi, k\in\BZ$&$(-\infty,+\infty)$&无界&$\pi$&奇函数\\\hline
			正割 $\sec x$&$x\neq \bigl(k+\half\bigr)\pi, k\in\BZ$&$(-\infty,-1]\cup[1,+\infty)$&无界&$2\pi$&偶函数\\\hline
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.5]
			...
			\begin{scope}[visible on=<2>]
				\draw[cstcurve,main,smooth,domain=-390:390] plot ({\x/180*pi},{sin (\x)});
				\draw (2,1.4) node[main] {$y=\sin x$};
				\draw[cstdash,fifth] (1.57,0)--(1.57,1)--(0,1);
			\end{scope}
			\begin{scope}[visible on=<3>]
				\draw[cstcurve,second,smooth,domain=-390:390] plot ({\x/180*pi},{cos (\x)});
				\draw (1.9,1.4) node[second] {$y=\cos x$};
			\end{scope}
			\begin{scope}[visible on=<4>]
				\begin{scope}[cstcurve,third,smooth,domain=-70:70]
					...
					\draw plot ({(\x-360)/180*pi},{tan (\x)});
				\end{scope}
				\draw (7.4,-1.2) node[third] {$y=\tan x$};
				\draw[cstdash,fourth]
					( 1.57,-3)--( 1.57,3)
					(-1.57,-3)--(-1.57,3)
					( 4.71,-3)--( 4.71,3)
			...
			\end{scope}
			\begin{scope}[visible on=<5>]
				\begin{scope}[cstcurve,main,smooth,domain=-70:70]
					\draw plot ({(270-\x)/180*pi},{tan (\x)});
					\draw plot ({(90-\x)/180*pi},{tan (\x)});
					\draw plot ({(-90-\x)/180*pi},{tan (\x)});
					\draw plot ({(-270-\x)/180*pi},{tan (\x)});
				\end{scope}
				\draw (6,1.2) node[main] {$y=\cot x$};
				\draw[cstdash,fourth]
					( 3.14,-3)--( 3.14,3)
					(-3.14,-3)--(-3.14,3)
					( 6.28,-3)--( 6.28,3)
			...
			\end{scope}
			\begin{scope}[visible on=<6>]
				\begin{scope}[cstcurve,second,smooth,domain=20:160]
				...
				\end{scope}
				\draw (2.6,1.2) node[second] {$y=\sec x$};
				\draw[cstdash,fourth]
					( 1.57,-3)--( 1.57,3)
					(-1.57,-3)--(-1.57,3)
					( 4.71,-3)--( 4.71,3)
...
\begin{frame}{反三角函数}
	...
	\begin{definition}
		\onslide<2->{
		\begin{tikzpicture}[overlay]\begin{tikzpicture}[xshift=-65mm,yshift=20mm]
			\draw[cstaxis] (-1.8,0)--(1.8,0);
			\draw[cstaxis] (0,-2)--(0,3.6);
			\draw[cstcurve,main,smooth,domain=-90:90] plot ({sin (\x)},{\x/180*pi});
			\draw (2.2,1.4) node[main] {$y=\arcsin x$};
			\begin{scope}[visible on=<3->]
				\draw[cstdash,fifth] (0,1.57)--(1,1.57)--(1,0) (0,-1.57)--(-1,-1.57)--(-1,0);
				\draw
	...
	\end{definition}
	\onslide<+->
	二者满足等式 \alert{$\arcsin x+\arccos x=\pi/2$}.
\end{frame}
...
\begin{frame}{反三角函数}
	...
	\begin{definition}
		\begin{enumerate}
			...
			\onslide<+->{定义域为 $(-\infty,+\infty)$, 值域为 $\left(-\dfrac\pi2,\dfrac\pi2\right)$.
			}\onslide<+->{有界、单调递增奇函数.
			}\onslide<+->{有两条渐近线 $y=\pm\pi/2$.}
	...
	\onslide<2->{
		...
		\begin{tikzpicture}[scale=0.5]
			...
			\draw[cstcurve,main,smooth,domain=-78:78] plot ({tan (\x)},{\x/180*pi});
			\draw (-3.4,-0.6) node[main] {$y=\arctan x$};
			\begin{scope}[visible on=<3->]
				\draw[cstdash,fourth] (-5,1.57)--(5,1.57) (-5,-1.57)--(5,-1.57);
				\draw
			...
			\end{scope}
			\begin{scope}[visible on=<7->]
				\draw[cstdash,fourth] (-5,3.14)--(5,3.14);
	...
	\end{definition}
	\onslide<+->
	二者满足等式 \alert{$\arctan x+\arccot x=\pi/2$}.
\end{frame}
...
\begin{frame}{双曲函数}
	...
	\begin{definition}
		\onslide<2->{
		\begin{tikzpicture}[overlay]\begin{tikzpicture}[xshift=-45mm,yshift=12mm]
			\draw[cstaxis] (-3,0)--(3,0);
			\draw[cstaxis] (0,-1.2)--(0,2.5);
			\draw[cstcurve,main,smooth,domain=-1:1.2] plot (\x,{(e^\x-e^(-\x))/2});
			\draw (2.1,1.6) node[main] {$y=\sh x$};
			\begin{scope}[second,visible on=<3->]
				\draw[cstcurve,smooth,domain=-1.5:1.5] plot (\x,{(e^\x+e^(-\x))/2});
				\draw (-1.8,1.3) node {$y=\ch x$};
			\end{scope}
			\begin{scope}[third,visible on=<4->]
				\draw[cstcurve,smooth,domain=-3:3] plot (\x,{1-2/(e^(2*\x)+1)});
				\draw (-1.8,-0.6) node {$y=\tanh x$};
			\end{scope}
			\draw[cstdash,fourth,visible on=<7->] (-3,1)--(3,1) (-3,-1)--(3,-1);
			\draw
				(0.2,-0.2) node {$O$}
				(2.8,-0.2) node {$x$}
				(0.2,2.3) node {$y$};
...
\begin{frame}{反双曲函数}
	...
	\begin{definition}
	\onslide<2->{
	\begin{tikzpicture}[overlay]\begin{tikzpicture}[xshift=-42mm,yshift=21mm]
		\draw[cstaxis] (0,-1.4)--(0,1.9);
		\draw[cstaxis] (-2.5,0)--(3,0);
		\draw[cstcurve,main,smooth,domain=-1.65:1.85] plot ({(e^\x-e^(-\x))/2},\x);
		\draw (-2,-0.7) node[main] {$y=\arsh x$};
		\begin{scope}[second,visible on=<3->]
		...
		\end{scope}
		\draw[cstdash,fourth,visible on=<7->] (1,-1.9)--(1,1.9) (-1,-1.9)--(-1,1.9);
		\draw
			(0.2,-0.2) node {$O$}
			(2.8,-0.2) node {$x$}
			(0.2,1.7) node {$y$};
