...
\begin{frame}{三角函数}
	...
	\begin{center}
		\begin{tabular}{cccccc} \toprule
			三角函数&定义域&值域&有界性&周期&奇偶性\\\toprule
			正弦 $\sin x$&$(-\infty,+\infty)$&$[-1,1]$&有界&$2\pi$&奇函数\\\midrule
			余弦 $\cos x$&$(-\infty,+\infty)$&$[-1,1]$&有界&$2\pi$&偶函数\\\midrule
			正切 $\tan x$&$x\neq \bigl(k+\half\bigr)\pi, k\in\BZ$&$(-\infty,+\infty)$&无界&$\pi$&奇函数\\\midrule
			余切 $\cot x$&$x\neq k\pi, k\in\BZ$&$(-\infty,+\infty)$&无界&$\pi$&奇函数\\\midrule
			正割 $\sec x$&$x\neq \bigl(k+\half\bigr)\pi, k\in\BZ$&$(-\infty,-1]\cup[1,+\infty)$&无界&$2\pi$&偶函数\\\midrule
			余割 $\csc x$&$x\neq k\pi, k\in\BZ$&$(-\infty,-1]\cup[1,+\infty)$&无界&$2\pi$&奇函数\\ \bottomrule
		\end{tabular}
	\end{center}
	\onslide<+->
	\begin{center}
