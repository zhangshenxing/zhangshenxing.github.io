...
\begin{frame}{三角函数的基本不等式}
	...
	\begin{proof}
		\begin{tikzpicture}[overlay]\begin{tikzpicture}[framed,xshift=-90mm,yshift=28mm]
			...
			\draw[dcolorb,thick] (A)--(B)--(C) pic [draw, "$x$",angle eccentricity=2,angle radius=2mm] {angle};
			\draw[cstcurve,dcolora] (A)--(B)--(C)--cycle (A)--(0.5,{0.5*sqrt 3})--cycle;
