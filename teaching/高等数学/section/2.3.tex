...
% \end{proof}
% 	(1) \forall\varepsilon>0, \exists \delta1>0 使得当 0<x-x0<\delta1 时, 有 $f(x)$-A<\varepsilon 
% 2;
% 	\exists \delta2>0 使得当 0<x-x0<\delta2 时, 有 g x-𝐵<\varepsilon 
% 2.
% 	因此, 当 0<x-x0<\delta=min \delta1 , \delta2 时, 有
...
% 	由局部有界性, \exists \delta1 , M>0 使得当 0<x-x0<\delta1 时, 有 $f(x)$ ≤ M.
% 	\forall\varepsilon>0, \exists \delta2>0 使得当 0<x-x0<\delta2 时, 有 $f(x)$-A<\varepsilon 
% 2 𝐵+1 ;
% 	\exists \delta3>0 使得当 0<x-x0<\delta3 时, 有 g x-𝐵<\varepsilon 
% 2M.
% 	因此, 当 0<x-x0<\delta=min \delta1 , \delta2 , \delta3 时, 有
...
% 使得其有个非零下界.
% 	对于 \varepsilon =𝐵
% 2>0, \exists \delta1>0 使得当 0<x-x0<\delta1 时, 有 g x-𝐵 ≤
% \varepsilon =𝐵
% 2 . 于是
% g x \ge 𝐵-g x-𝐵 \ge 𝐵
% 2 ,
...
% \begin{frame}
% 	\forall\varepsilon>0, \exists \delta2>0 使得当 0<x-x0<\delta2 时, 有 g x-𝐵<𝐵 2
% 2 \varepsilon .
% 	因此当 0<x-x0<\delta=min \delta1 , \delta2 时,
% 1
% g x-1
% 𝐵=g x-𝐵
% 𝐵 \cdot g x ≤ 2
...
% 	由 \lim\limits_
% x\rax0
% 𝜑 x=a 知 \exists \delta1>0 使得当 0<x-x0<\delta1 时, 有 𝜑 x-a<𝜂 .
% 	设 𝑢=𝜑 x 在 𝑈
% ∘
% x0 , \delta2 上不等于 a, 则当 0<x-x0<\delta=min \delta1 , \delta2 时, 有
...
% x+ x0
% .
% 	\forall\varepsilon>0, 令 \delta=min x0
% 2 , x0 \varepsilon  . 当 0<x-x0<\delta 时, 有
% x+ x0>x0 , x-x0=x-x0
% x+ x0
% < x0 \varepsilon 
% x0
