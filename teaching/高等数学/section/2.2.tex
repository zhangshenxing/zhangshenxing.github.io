...
\begin{frame}{函数在 $+\infty$ 的极限}
	...
	\begin{definition}
		...
		\onslide<+->{\begin{tikzpicture}[overlay]
			\draw[semithick,dcolorc] (1.3,1.3) rectangle (10.5,2);
			\draw (11.6,1.65) node[dcolorc] {$\varepsilon$-$X$ 语言};
		\end{tikzpicture}}
	\end{definition}
\end{frame}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\begin{scope}[visible on=<1>]
				\draw[cstdash,dcolord] (0,1)--(9,1);
				\draw (-0.25,1) node {$A$};
			\end{scope}
			\begin{scope}[visible on=<2->]
				\draw[cstdash,dcolore] (0,1.2)--(9,1.2);
				\draw[cstdash,dcolore] (0,0.8)--(9,0.8);
				\draw[cstdash,dcolorc] (4,0)--(4,1.2);
				\draw (-0.6,1.2) node {$A+\varepsilon$};
				\draw (-0.6,0.8) node {$A-\varepsilon$};
				\draw (4,-0.25) node {$X$};
			\end{scope}
			\draw[cstcurve,dcolora,smooth,domain=1.2:9.5] plot({\x-1},{1+3*sin(\x*240)/(1+\x*\x)});
		\end{tikzpicture}
	\end{center}
...
\begin{frame}{函数在一点的极限}
	...
	\begin{center}
		\begin{tikzpicture}[framed]
			...
			\draw[cstcurve,dcolora,smooth,domain=0.02:1.6] plot({4+2*\x},{2+1.4*\x*sin(1/\x*180)});
			\draw[cstcurve,dcolora,smooth,domain=0.02:1.6] plot({4-2*\x},{2+1.4*\x*sin(1/\x*180)});
			\begin{scope}[visible on=<3>]
				\draw[cstdash,dcolord] (0,2)--(10,2);
				\draw (-0.25,2) node {$A$};
				\draw (4,-0.25) node {$x_0$};
			\end{scope}
			\begin{scope}[visible on=<4->]
				\draw[cstdash,dcolore] (0,2.4)--(10,2.4);
				\draw[cstdash,dcolore] (0,1.6)--(10,1.6);
				\draw[cstdash,dcolorc] (3.25,0)--(3.25,2.4);
				\draw[cstdash,dcolorc] (4.75,0)--(4.75,2.4);
			...
			\fill[cstdot,dcolora] (4,1) circle;
		\end{tikzpicture}
	\end{center}
\end{frame}
...
\begin{frame}{函数在一点的极限}
	...
	\begin{definition}
		...
		\end{center}
			...
			\draw[semithick,dcolorc] (1.8,1.2) rectangle (12.4,1.9);
			\draw (13.4,1.55) node[dcolorc] {$\varepsilon$-$\delta$ 语言};
		\end{tikzpicture}}
	\end{definition}
\end{frame}
