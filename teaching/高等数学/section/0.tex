...
\begin{frame}{课程学习方法}
	\begin{center}
		\begin{tikzpicture}[node distance=25pt]
			...
			\draw[cstnra,third] (1.east) to[bend left] (2.north);
			\draw[cstnra,third] (2.south) to[bend left] (3.east);
			\draw[cstnra,third] (3.west) to[bend left] (4.south);
			\draw[cstnra,third] (4.north) to[bend left] (1.west);
		\end{tikzpicture}
	\end{center}
\end{frame}
