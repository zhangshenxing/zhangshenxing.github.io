...
\input{../latex/cn_talk}
\title{不同椭圆曲线的二次扭之比较}
\invitedby[cnu]{首师大数论和代数几何研讨会2024春}
\date{2024年6月20日}
...
那么下述等价
\begin{enumerate}
\item $\rank_\BZ \CE^{(n)}(\BQ)=0,\Sha\bigl(\CE^{(n)}/\BQ\bigr)[2^\infty]\cong(\BZ/2\BZ)^2$;
...
那么下述等价
\begin{enumerate}
\item $\rank_\BZ \CE^{(2n)}(\BQ)=0,\Sha\bigl(\CE^{(2n)}/\BQ\bigr)[2^\infty]\cong(\BZ/2\BZ)^2$;
