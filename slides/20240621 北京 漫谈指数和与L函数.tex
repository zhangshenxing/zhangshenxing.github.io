...
\begin{frame}{Kloosterman 和}
	\beqskip{4pt}
	\onslide<+->
	\begin{example}[near,leftupper=0pt][Deligne SGA4$\half$, Serre1977]
		\begin{itemize}
...
% 	\end{split}
% 	\]
% 其中 $\phi(n)=\min\{x_1+\cdots+x_d\mid \sum ix_i=n,x_i\ge0\}\in\BN\cup\{+\infty\}.$
% \end{frame}
...
% 称 $\bchi$ 是 \emph{Kummer 诱导的}, 若存在非平凡特征 $\Lambda$ 使得作为无序数组 $\bchi=\bchi\Lambda:=\{\chi_1\Lambda,\dots,\chi_n\Lambda\}$.
