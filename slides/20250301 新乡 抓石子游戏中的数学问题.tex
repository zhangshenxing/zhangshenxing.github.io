  ...
  \begin{itemize}
    ...
    \begin{center}
      ...
      \begin{tikzpicture}
        ...
        \draw[visible on=<9->,red] (2,0) node[below=3mm] {$2$};
        ...
        \end{scope}
        \draw[visible on=<10->,red] (3,0) circle (\r) node {$3$} node[below=3mm] {$3$};
        ...
        \end{scope}
        \draw[visible on=<11->,blue] (4,0) circle (\r) node {$4$} node[below=3mm] {$0$};
        \begin{scope}[visible on=<12->,red]
      ...
      \end{tikzpicture}}
    \end{center}
    \onslide<+->\onslide<+->\onslide<+->\onslide<+->\onslide<+->\onslide<+->\onslide<+->\onslide<+->\onslide<+->\onslide<+->
