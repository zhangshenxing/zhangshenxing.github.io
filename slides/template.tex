...
\usetheme{reed}
\AtBeginSection{% Add toc after section automatically
...
\email{\href{mailto:nongzhangyu@hzu.edu.cn}{nongzhangyu@hzu.edu.cn}}
\date{2022-05-19}
\titlegraphic{misc/hzu.png}
\institutegraphic{misc/hzuname.png}

% Custom main color, default blue
%\definecolor{structcolor}{RGB}{48,55,157}
...
\begin{document}
{
	\setbeamertemplate{footline}{}% Remove footline in title page
	\frame{\titlepage}
}
